...
.field public final c:Lc/g/a/k$f;
...
.method public constructor <init>(Lc/g/a/k$f;)V
    ...
    iput-object v0, p0, Lc/g/a/l;->f:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lc/g/a/l;->g:Landroid/os/Bundle;

    iput-object p1, p0, Lc/g/a/l;->c:Lc/g/a/k$f;

    iget-object v0, p1, Lc/g/a/k$f;->a:Landroid/content/Context;

    iput-object v0, p0, Lc/g/a/l;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lc/g/a/k$f;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lc/g/a/k$f;->L:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lc/g/a/k$f;->U:Landroid/app/Notification;

    iget-object v3, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lc/g/a/k$f;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lc/g/a/k$f;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lc/g/a/k$f;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lc/g/a/k$f;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lc/g/a/k$f;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lc/g/a/k$f;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lc/g/a/k$f;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lc/g/a/k$f;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lc/g/a/k$f;->u:I

    iget v9, p1, Lc/g/a/k$f;->v:I

    iget-boolean v10, p1, Lc/g/a/k$f;->w:Z
    ...
    iget-object v4, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lc/g/a/k$f;->r:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lc/g/a/k$b;

    invoke-virtual {p0, v8}, Lc/g/a/l;->b(Lc/g/a/k$b;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lc/g/a/k$f;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Lc/g/a/l;->g:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Lc/g/a/k$f;->A:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Lc/g/a/l;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lc/g/a/k$f;->x:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lc/g/a/k$f;->y:Z
    ...
    :cond_a
    iget-object v0, p1, Lc/g/a/k$f;->z:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lc/g/a/k$f;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/g/a/l;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lc/g/a/k$f;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/g/a/l;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lc/g/a/k$f;->n:Z
    ...
    iget-object v8, p1, Lc/g/a/k$f;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lc/g/a/l;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lc/g/a/k$f;->X:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lc/g/a/l;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, Lc/g/a/l;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, Lc/g/a/k$f;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lc/g/a/l;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lc/g/a/k$f;->X:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lc/g/a/l;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, Lc/g/a/k$f;->X:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, Lc/g/a/k$f;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/g/a/l;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lc/g/a/k$f;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lc/g/a/k$f;->j()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, Lc/g/a/k$f;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lc/g/a/k$f;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lc/g/a/k$b;

    invoke-static {v12}, Lc/g/a/m;->f(Lc/g/a/k$b;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Lc/g/a/k$f;->W:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, Lc/g/a/k$f;->I:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, Lc/g/a/k$f;->J:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, Lc/g/a/k$f;->K:Landroid/widget/RemoteViews;
    ...
    check-cast v4, Lc/g/a/o;

    iget-object v7, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lc/g/a/o;->j()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Lc/g/a/k$f;->S:Z
    ...
    iget-object v7, p1, Lc/g/a/k$f;->T:Lc/g/a/k$e;

    invoke-static {v7}, Lc/g/a/k$e;->k(Lc/g/a/k$e;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object v4, p1, Lc/g/a/k$f;->O:Lc/g/b/b;

    if-eqz v4, :cond_1c

    iget-object v7, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lc/g/b/b;->b()Landroid/content/LocusId;
    ...
    :cond_1d
    iget-boolean p1, p1, Lc/g/a/k$f;->V:Z

    if-eqz p1, :cond_20

    iget-object p1, p0, Lc/g/a/l;->c:Lc/g/a/k$f;

    iget-boolean p1, p1, Lc/g/a/k$f;->y:Z

    if-eqz p1, :cond_1e

    iput v5, p0, Lc/g/a/l;->h:I

    goto :goto_b

    :cond_1e
    iput v6, p0, Lc/g/a/l;->h:I

    :goto_b
    iget-object p1, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lc/g/a/k$f;->x:Ljava/lang/String;
...
.method public static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lc/d/b;-><init>(I)V

    invoke-virtual {v0, p0}, Lc/d/b;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v0, p1}, Lc/d/b;->addAll(Ljava/util/Collection;)Z
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, Lc/g/a/o;

    invoke-virtual {v1}, Lc/g/a/o;->i()Ljava/lang/String;
...
.method public final b(Lc/g/a/k$b;)V
    .locals 5
    ...
    invoke-static {v1}, Lc/g/a/q;->b([Lc/g/a/q;)[Landroid/app/RemoteInput;
    ...
    iget-object v0, p0, Lc/g/a/l;->f:Ljava/util/List;

    iget-object v1, p0, Lc/g/a/l;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lc/g/a/m;->j(Landroid/app/Notification$Builder;Lc/g/a/k$b;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lc/g/a/l;->c:Lc/g/a/k$f;

    iget-object v0, v0, Lc/g/a/k$f;->q:Lc/g/a/k$j;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lc/g/a/k$j;->b(Lc/g/a/j;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lc/g/a/k$j;->u(Lc/g/a/j;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Lc/g/a/l;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Lc/g/a/l;->c:Lc/g/a/k$f;

    iget-object v1, v1, Lc/g/a/k$f;->I:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lc/g/a/k$j;->t(Lc/g/a/j;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Lc/g/a/l;->c:Lc/g/a/k$f;

    iget-object v4, v4, Lc/g/a/k$f;->q:Lc/g/a/k$j;

    invoke-virtual {v4, p0}, Lc/g/a/k$j;->v(Lc/g/a/j;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lc/g/a/k;->k(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lc/g/a/k$j;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0}, Lc/g/a/l;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lc/g/a/l;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lc/g/a/l;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Lc/g/a/l;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Lc/g/a/l;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lc/g/a/m;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lc/g/a/k;->k(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, Lc/g/a/l;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lc/g/a/l;->f:Ljava/util/List;

    invoke-static {v1}, Lc/g/a/m;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    iget-object v0, p0, Lc/g/a/l;->a:Landroid/content/Context;
