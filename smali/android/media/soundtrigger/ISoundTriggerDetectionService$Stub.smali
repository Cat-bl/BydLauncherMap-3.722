...
.field public static final TRANSACTION_onGenericRecognitionEvent:I = 0x3

.field public static final TRANSACTION_onStopOperation:I = 0x5

.field public static final TRANSACTION_removeClient:I = 0x2

.field public static final TRANSACTION_setClient:I = 0x1
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "onStopOperation"
    ...
    :cond_2
    const-string p0, "onGenericRecognitionEvent"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v2, "android.media.soundtrigger.ISoundTriggerDetectionService"
    ...
    invoke-interface {p0, v0, p1}, Landroid/media/soundtrigger/ISoundTriggerDetectionService;->onStopOperation(Landroid/os/ParcelUuid;I)V
    ...
    invoke-interface {p0, v0, p1, p2}, Landroid/media/soundtrigger/ISoundTriggerDetectionService;->onError(Landroid/os/ParcelUuid;II)V
    ...
    check-cast v0, Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;

    :cond_7
    invoke-interface {p0, p1, p3, v0}, Landroid/media/soundtrigger/ISoundTriggerDetectionService;->onGenericRecognitionEvent(Landroid/os/ParcelUuid;ILandroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)V
    ...
    :cond_9
    invoke-interface {p0, v0}, Landroid/media/soundtrigger/ISoundTriggerDetectionService;->removeClient(Landroid/os/ParcelUuid;)V
    ...
    invoke-interface {p0, p1, v0, p2}, Landroid/media/soundtrigger/ISoundTriggerDetectionService;->setClient(Landroid/os/ParcelUuid;Landroid/os/Bundle;Landroid/media/soundtrigger/ISoundTriggerDetectionServiceClient;)V
