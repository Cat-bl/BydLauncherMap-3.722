...
# direct methods
.method public constructor <init>(Lh/a/e0/c/a;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lh/a/e0/c/a;
...
.method public fastPath()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lh/a/e0/c/a;
    ...
    :cond_3
    invoke-interface {v1, v2}, Lh/a/e0/c/a;->tryOnNext(Ljava/lang/Object;)Z
...
.method public slowPath(J)V
    ...
    :cond_4
    invoke-interface {v1, v6}, Lh/a/e0/c/a;->tryOnNext(Ljava/lang/Object;)Z
