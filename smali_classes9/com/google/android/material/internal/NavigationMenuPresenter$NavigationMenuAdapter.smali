...
# instance fields
.field private checkedItem:Lc/b/f/j/i;
...
.method private prepareMenuItems()V
    ...
    iget-object v3, v3, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Lc/b/f/j/g;

    invoke-virtual {v3}, Lc/b/f/j/g;->getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-object v8, v8, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Lc/b/f/j/g;

    invoke-virtual {v8}, Lc/b/f/j/g;->getVisibleItems()Ljava/util/ArrayList;
    ...
    check-cast v8, Lc/b/f/j/i;

    invoke-virtual {v8}, Lc/b/f/j/i;->isChecked()Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v0, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Lc/b/f/j/i;)V

    :cond_1
    invoke-virtual {v8}, Lc/b/f/j/i;->isCheckable()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v8, v4}, Lc/b/f/j/i;->t(Z)V

    :cond_2
    invoke-virtual {v8}, Lc/b/f/j/i;->hasSubMenu()Z

    move-result v9

    if-eqz v9, :cond_9

    invoke-virtual {v8}, Lc/b/f/j/i;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-direct {v11, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lc/b/f/j/i;)V
    ...
    invoke-virtual {v14}, Lc/b/f/j/i;->isVisible()Z
    ...
    invoke-virtual {v14}, Lc/b/f/j/i;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-virtual {v14}, Lc/b/f/j/i;->isCheckable()Z

    move-result v15

    if-eqz v15, :cond_5

    invoke-virtual {v14, v4}, Lc/b/f/j/i;->t(Z)V
    ...
    invoke-direct {v1, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lc/b/f/j/i;)V
    ...
    :cond_9
    invoke-virtual {v8}, Lc/b/f/j/i;->getGroupId()I
    ...
    invoke-virtual {v8}, Lc/b/f/j/i;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Lc/b/f/j/i;)V
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lc/b/f/j/i;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lc/b/f/j/i;->getItemId()I
    ...
    invoke-virtual {v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lc/b/f/j/i;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lc/b/f/j/i;->getActionView()Landroid/view/View;
    ...
    invoke-virtual {v4}, Lc/b/f/j/i;->getItemId()I
...
.method public getCheckedItem()Lc/b/f/j/i;
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lc/b/f/j/i;
...
.method public getItemViewType(I)I
    ...
    invoke-virtual {p1}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lc/b/f/j/i;
...
.method public onBindViewHolder(Lcom/google/android/material/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lc/b/f/j/i;

    move-result-object p2

    invoke-virtual {p2}, Lc/b/f/j/i;->getTitle()Ljava/lang/CharSequence;
    ...
    :goto_0
    invoke-static {p1, v0}, Lc/g/j/e0;->x0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, p2, v1}, Lcom/google/android/material/internal/NavigationMenuItemView;->initialize(Lc/b/f/j/i;I)V
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Lc/b/f/j/i;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Lc/b/f/j/i;
    ...
    :cond_4
    invoke-virtual {v2}, Lc/b/f/j/i;->getActionView()Landroid/view/View;
...
.method public setCheckedItem(Lc/b/f/j/i;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lc/b/f/j/i;->isCheckable()Z
    ...
    invoke-virtual {v0, v1}, Lc/b/f/j/i;->setChecked(Z)Landroid/view/MenuItem;

    :cond_1
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Lc/b/f/j/i;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lc/b/f/j/i;->setChecked(Z)Landroid/view/MenuItem;
