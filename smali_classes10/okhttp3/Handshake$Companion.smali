...
.method public final a(Ljavax/net/ssl/SSLSession;)Lokhttp3/Handshake;
    ...
    :goto_0
    sget-object v1, Lm/h;->r1:Lm/h$b;

    invoke-virtual {v1, v0}, Lm/h$b;->b(Ljava/lang/String;)Lm/h;
    ...
    invoke-static {v2, v1}, Lk/w/c/r;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-direct {v3, v1, v0, p1, v4}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lm/h;Ljava/util/List;Lk/w/b/a;)V
...
.method public final b(Lokhttp3/TlsVersion;Lm/h;Ljava/util/List;Ljava/util/List;)Lokhttp3/Handshake;
    .locals 2
    ...
    invoke-static {p3}, Lm/d0/b;->O(Ljava/util/List;)Ljava/util/List;

    move-result-object p3

    new-instance v0, Lokhttp3/Handshake;

    invoke-static {p4}, Lm/d0/b;->O(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, p4, v1}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lm/h;Ljava/util/List;Lk/w/b/a;)V
...
.method public final c([Ljava/security/cert/Certificate;)Ljava/util/List;
    ...
    invoke-static {p1}, Lm/d0/b;->t([Ljava/lang/Object;)Ljava/util/List;
