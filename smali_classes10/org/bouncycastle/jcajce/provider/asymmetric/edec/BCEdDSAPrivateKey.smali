...
.field public transient eddsaPrivateKey:Lo/a/b/s/a;
...
.method public constructor <init>(Lo/a/a/o3/d;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->populateFromPrivateKeyInfo(Lo/a/a/o3/d;)V
...
.method public constructor <init>(Lo/a/b/s/a;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->eddsaPrivateKey:Lo/a/b/s/a;
...
.method private populateFromPrivateKeyInfo(Lo/a/a/o3/d;)V
    ...
    new-instance p1, Lo/a/b/s/w;

    invoke-direct {p1, v0}, Lo/a/b/s/w;-><init>([B)V

    goto :goto_0

    :cond_0
    new-instance p1, Lo/a/b/s/u;

    invoke-direct {p1, v0}, Lo/a/b/s/u;-><init>([B)V
...
.method public engineGetKeyParameters()Lo/a/b/s/a;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->eddsaPrivateKey:Lo/a/b/s/a;
...
.method public getEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPrivateKey;->eddsaPrivateKey:Lo/a/b/s/a;
...
.method public getPublicKey()Lorg/bouncycastle/jcajce/interfaces/EdDSAPublicKey;
    ...
    instance-of v1, v0, Lo/a/b/s/w;

    if-eqz v1, :cond_0

    new-instance v1, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;

    check-cast v0, Lo/a/b/s/w;

    invoke-virtual {v0}, Lo/a/b/s/w;->b()Lo/a/b/s/x;

    move-result-object v0

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;-><init>(Lo/a/b/s/a;)V
    ...
    check-cast v0, Lo/a/b/s/u;

    invoke-virtual {v0}, Lo/a/b/s/u;->b()Lo/a/b/s/v;
