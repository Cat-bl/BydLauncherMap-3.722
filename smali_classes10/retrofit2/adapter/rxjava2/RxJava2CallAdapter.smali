...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Type;Lh/a/v;ZZZZZZZ)V
    .locals 0
    .param p2    # Lh/a/v;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    iput-object p2, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:Lh/a/v;
...
.method public adapt(Lretrofit2/Call;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/ResultObservable;-><init>(Lh/a/n;)V
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/BodyObservable;-><init>(Lh/a/n;)V

    goto :goto_1

    :cond_2
    :goto_2
    iget-object p1, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:Lh/a/v;

    if-eqz p1, :cond_3

    invoke-virtual {v0, p1}, Lh/a/n;->subscribeOn(Lh/a/v;)Lh/a/n;
    ...
    invoke-virtual {v0, p1}, Lh/a/n;->toFlowable(Lio/reactivex/BackpressureStrategy;)Lh/a/g;
    ...
    invoke-virtual {v0}, Lh/a/n;->singleOrError()Lh/a/w;
    ...
    invoke-virtual {v0}, Lh/a/n;->singleElement()Lh/a/j;
    ...
    invoke-virtual {v0}, Lh/a/n;->ignoreElements()Lh/a/a;
