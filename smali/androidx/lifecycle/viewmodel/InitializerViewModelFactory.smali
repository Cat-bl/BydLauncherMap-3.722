...
# virtual methods
.method public bridge synthetic create(Ljava/lang/Class;)Lc/o/a0;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-super {p0, p1}, Lc/o/b0$b;->create(Ljava/lang/Class;)Lc/o/a0;
...
.method public create(Ljava/lang/Class;Landroidx/lifecycle/viewmodel/CreationExtras;)Lc/o/a0;
    ...
    invoke-static {v6, p1}, Lk/w/c/r;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-virtual {v5}, Landroidx/lifecycle/viewmodel/ViewModelInitializer;->getInitializer$lifecycle_viewmodel_release()Lk/w/b/l;

    move-result-object v4

    invoke-interface {v4, p2}, Lk/w/b/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    instance-of v5, v4, Lc/o/a0;

    if-eqz v5, :cond_0

    check-cast v4, Lc/o/a0;
