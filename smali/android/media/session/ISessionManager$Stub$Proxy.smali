.class public Landroid/media/session/ISessionManager$Stub$Proxy;
...
.method public dispatchVolumeKeyEvent(Ljava/lang/String;Ljava/lang/String;ZLandroid/view/KeyEvent;IZ)V
    ...
    :try_start_1
    iget-object v1, v10, Landroid/media/session/ISessionManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public dispatchVolumeKeyEventToSessionAsSystemService(Ljava/lang/String;Ljava/lang/String;Landroid/media/session/MediaSession$Token;Landroid/view/KeyEvent;)V
    ...
    invoke-interface {v2, p1, p2, p3, p4}, Landroid/media/session/ISessionManager;->dispatchVolumeKeyEventToSessionAsSystemService(Ljava/lang/String;Ljava/lang/String;Landroid/media/session/MediaSession$Token;Landroid/view/KeyEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getSession2Tokens(I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-interface {v2, p1}, Landroid/media/session/ISessionManager;->getSession2Tokens(I)Landroid/content/pm/ParceledListSlice;
...
.method public notifySession2Created(Landroid/media/Session2Token;)V
    ...
    invoke-interface {v2, p1}, Landroid/media/session/ISessionManager;->notifySession2Created(Landroid/media/Session2Token;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerRemoteVolumeController(Landroid/media/IRemoteVolumeController;)V
    ...
    invoke-interface {v2, p1}, Landroid/media/session/ISessionManager;->registerRemoteVolumeController(Landroid/media/IRemoteVolumeController;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setCallback(Landroid/media/session/ICallback;)V
    ...
    invoke-interface {v2, p1}, Landroid/media/session/ISessionManager;->setCallback(Landroid/media/session/ICallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public unregisterRemoteVolumeController(Landroid/media/IRemoteVolumeController;)V
    ...
    invoke-interface {v2, p1}, Landroid/media/session/ISessionManager;->unregisterRemoteVolumeController(Landroid/media/IRemoteVolumeController;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
