.class public Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->refreshRouteFromWayPointChanged(Ljava/util/ArrayList;Z)V
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;Z)V
    .locals 0

    iput-object p1, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->b:Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;

    iput-boolean p2, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->a:Z
...
.method private synthetic a(I)V
    ...
    iget-object p1, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->b:Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;
    ...
    invoke-static {p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5800(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lf/h/i/c/l;
...
.method public synthetic b(I)V
    ...
    invoke-direct {p0, p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->a(I)V
...
.method public callback(Lcom/autosdk/bussiness/navi/route/model/IRouteResultData;Z)V
    ...
    iget-object v0, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->b:Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;
    ...
    iget-boolean v1, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->a:Z
    ...
    const-string v2, "way point changed, added: {?}, requestRoute callback isLocal :{?} "
    ...
    iget-object p2, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->b:Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;

    invoke-static {p2}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5200(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lf/h/i/c/l;
    ...
    invoke-virtual {p2, p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->updateRouteCarResultData(Lcom/autosdk/bussiness/navi/route/model/RouteCarResultData;)V
    ...
    iput-object p2, p1, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->mPathResult:Ljava/util/ArrayList;

    iget-object p1, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->b:Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;

    invoke-static {p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5300(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lf/h/i/c/l;
    ...
    invoke-static {p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5400(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lcom/autosdk/bussiness/layer/LayerController;
    ...
    invoke-virtual {p1}, Lcom/autosdk/bussiness/layer/DrivingLayer;->clearRouteRestrict()V
    ...
    iget-boolean p1, p0, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;->a:Z
    ...
    invoke-static {p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5500(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lf/h/i/c/l;
    ...
    invoke-static {p1}, Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;->access$5600(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter;)Lf/h/i/c/l;
...
.method public errorCallback(ILjava/lang/String;Z)V
    ...
    const-string p3, "way point changed, added: {?}, requestRoute errorCallback errorCode:{?} errorMessage:{?} isLocal :{?} "
    ...
    new-instance p2, Lf/h/f/e2/d/y0;

    invoke-direct {p2, p0, p1}, Lf/h/f/e2/d/y0;-><init>(Lcom/autosdk/drive/route/presenter/RouteResultMapPresenter$h;I)V
