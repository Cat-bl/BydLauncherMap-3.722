...
.field public j:Lc/b/f/j/g;

.field public k:Lc/b/f/j/e;
...
# virtual methods
.method public a(Lc/b/f/j/m$a;)Lc/b/f/j/n;
    .locals 3

    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->j:Lc/b/f/j/g;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->k:Lc/b/f/j/e;

    if-nez v0, :cond_1

    new-instance v0, Lc/b/f/j/e;
    ...
    invoke-direct {v0, v1, v2}, Lc/b/f/j/e;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->k:Lc/b/f/j/e;

    invoke-virtual {v0, p1}, Lc/b/f/j/e;->setCallback(Lc/b/f/j/m$a;)V

    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->j:Lc/b/f/j/g;

    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->k:Lc/b/f/j/e;

    invoke-virtual {p1, v0}, Lc/b/f/j/g;->addMenuPresenter(Lc/b/f/j/m;)V

    :cond_1
    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->k:Lc/b/f/j/e;

    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->g:Landroid/view/ViewGroup;

    invoke-virtual {p1, v0}, Lc/b/f/j/e;->b(Landroid/view/ViewGroup;)Lc/b/f/j/n;
...
.method public c(Lc/b/f/j/g;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->k:Lc/b/f/j/e;

    invoke-virtual {v0, v1}, Lc/b/f/j/g;->removeMenuPresenter(Lc/b/f/j/m;)V

    :cond_1
    iput-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->j:Lc/b/f/j/g;
...
.method public d(Landroid/content/Context;)V
    ...
    new-instance v0, Lc/b/f/d;

    const/4 v2, 0x0

    invoke-direct {v0, p1, v2}, Lc/b/f/d;-><init>(Landroid/content/Context;I)V
