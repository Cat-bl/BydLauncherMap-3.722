...
.method private createVersion(Ljava/lang/Class;)Lcom/android/systemui/shared/plugins/VersionInfo$Version;
    ...
    check-cast p1, Lcom/android/systemui/plugins/annotations/ProvidesInterface;

    if-eqz p1, :cond_0

    new-instance v0, Lcom/android/systemui/shared/plugins/VersionInfo$Version;

    invoke-interface {p1}, Lcom/android/systemui/plugins/annotations/ProvidesInterface;->version()I

    move-result p1

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Lcom/android/systemui/shared/plugins/VersionInfo$Version;-><init>(IZ)V
