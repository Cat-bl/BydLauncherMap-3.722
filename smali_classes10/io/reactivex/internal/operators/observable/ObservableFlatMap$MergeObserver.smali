...
.method public constructor <init>(Lh/a/u;Lh/a/d0/o;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lh/a/d0/o;
...
.method public checkTerminate()Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;
...
.method public disposeAll()Z
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->upstream:Lh/a/a0/b;
...
.method public drainLoop()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;
    ...
    :cond_1
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lh/a/e0/c/g;
    ...
    :cond_2
    invoke-interface {v3}, Lh/a/e0/c/g;->poll()Ljava/lang/Object;
    ...
    :cond_3
    invoke-interface {v0, v4}, Lh/a/u;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lh/a/e0/c/g;
    ...
    invoke-interface {v4}, Lh/a/e0/c/h;->isEmpty()Z
    ...
    iget-object v11, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lh/a/e0/c/h;

    if-eqz v11, :cond_14

    :cond_11
    :try_start_1
    invoke-interface {v11}, Lh/a/e0/c/h;->poll()Ljava/lang/Object;
    ...
    :cond_12
    invoke-interface {v0, v12}, Lh/a/u;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v12, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lh/a/e0/c/h;
    ...
    invoke-virtual {p0, v4}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Lh/a/s;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lh/a/d0/o;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Lh/a/s;)V
...
.method public onSubscribe(Lh/a/a0/b;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->upstream:Lh/a/a0/b;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;
...
.method public subscribeInner(Lh/a/s;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;

    invoke-interface {p2, p1}, Lh/a/u;->onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    iget-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lh/a/e0/c/h;
    ...
    iput-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lh/a/e0/c/h;
...
.method public tryEmitScalar(Ljava/util/concurrent/Callable;)Z
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lh/a/u;
    ...
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lh/a/e0/c/g;
    ...
    :goto_0
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lh/a/e0/c/g;
