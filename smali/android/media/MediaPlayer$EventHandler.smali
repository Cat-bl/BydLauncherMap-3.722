...
.method public static synthetic access$2800(Landroid/media/MediaPlayer$EventHandler;)Landroid/media/MediaPlayer;
    .locals 0
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :catch_0
    invoke-virtual {p0, v4, v5, v1, v2}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {p1, v3}, Landroid/media/MediaPlayer;->access$1700(Landroid/media/MediaPlayer;Z)V
    ...
    invoke-interface {v0, p1, v2}, Landroid/media/MediaPlayer$OnTimedTextListener;->onTimedText(Landroid/media/MediaPlayer;Landroid/media/TimedText;)V
    ...
    :cond_11
    invoke-virtual {v0, v3}, Landroid/media/MediaPlayer$TimeProvider;->onPaused(Z)V
    ...
    invoke-static {p1}, Landroid/media/MediaPlayer;->access$3000(Landroid/media/MediaPlayer;)Landroid/util/ArrayMap;
    ...
    const-string v1, "MEDIA_DRM_INFO "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Landroid/media/MediaPlayer$EventHandler;->this$0:Landroid/media/MediaPlayer;

    invoke-static {v1}, Landroid/media/MediaPlayer;->access$1100(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnDrmInfoHandlerDelegate;
    ...
    invoke-virtual {p1, v2}, Landroid/media/MediaPlayer$OnDrmInfoHandlerDelegate;->notifyClient(Landroid/media/MediaPlayer$DrmInfo;)V
