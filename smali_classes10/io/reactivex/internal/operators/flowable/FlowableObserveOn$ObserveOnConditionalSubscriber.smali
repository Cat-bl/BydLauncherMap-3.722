...
.field public final downstream:Lh/a/e0/c/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/a/e0/c/a<",
            "-TT;>;"
...
# direct methods
.method public constructor <init>(Lh/a/e0/c/a;Lh/a/v$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lh/a/v$c;ZI)V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
...
.method public onSubscribe(Lo/g/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lo/g/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lo/g/d;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lh/a/e0/c/h;

    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;

    invoke-interface {v0, p0}, Lh/a/i;->onSubscribe(Lo/g/d;)V
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lh/a/e0/c/h;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lo/g/d;

    invoke-interface {v3, v1, v2}, Lo/g/d;->request(J)V
...
.method public runAsync()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lh/a/e0/c/h;
    ...
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLo/g/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v12}, Lh/a/e0/c/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lo/g/d;

    invoke-interface {v10, v4, v5}, Lo/g/d;->request(J)V
    ...
    invoke-interface {v0, v2}, Lo/g/c;->onError(Ljava/lang/Throwable;)V

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lh/a/v$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLo/g/c;)Z
...
.method public runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lo/g/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
...
.method public runSync()V
    ...
    :cond_3
    invoke-interface {v0, v8}, Lh/a/e0/c/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lo/g/d;

    invoke-interface {v2}, Lo/g/d;->cancel()V
