...
.field public static final TRANSACTION_closeDevice:I = 0x4

.field public static final TRANSACTION_closePort:I = 0x3

.field public static final TRANSACTION_connectPorts:I = 0x5

.field public static final TRANSACTION_getDeviceInfo:I = 0x6

.field public static final TRANSACTION_openInputPort:I = 0x1

.field public static final TRANSACTION_openOutputPort:I = 0x2

.field public static final TRANSACTION_setDeviceInfo:I = 0x7
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_5
    const-string p0, "openOutputPort"

    return-object p0

    :pswitch_6
    const-string p0, "openInputPort"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_0
    invoke-interface {p0, p1}, Landroid/media/midi/IMidiDeviceServer;->setDeviceInfo(Landroid/media/midi/MidiDeviceInfo;)V
    ...
    invoke-interface {p0}, Landroid/media/midi/IMidiDeviceServer;->getDeviceInfo()Landroid/media/midi/MidiDeviceInfo;
    ...
    invoke-virtual {p1, p3, v1}, Landroid/media/midi/MidiDeviceInfo;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface {p0, p1, p4, p2}, Landroid/media/midi/IMidiDeviceServer;->connectPorts(Landroid/os/IBinder;Ljava/io/FileDescriptor;I)I
    ...
    invoke-interface {p0}, Landroid/media/midi/IMidiDeviceServer;->closeDevice()V
    ...
    invoke-interface {p0, p1}, Landroid/media/midi/IMidiDeviceServer;->closePort(Landroid/os/IBinder;)V
    ...
    invoke-interface {p0, p1, p2}, Landroid/media/midi/IMidiDeviceServer;->openOutputPort(Landroid/os/IBinder;I)Ljava/io/FileDescriptor;
    ...
    invoke-interface {p0, p1, p2}, Landroid/media/midi/IMidiDeviceServer;->openInputPort(Landroid/os/IBinder;I)Ljava/io/FileDescriptor;
