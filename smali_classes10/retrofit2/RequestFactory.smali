...
.field private final headers:Lm/s;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lm/t;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lm/t;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lm/s;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lm/s;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lm/v;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lm/v;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lm/y;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lm/t;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lm/s;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lm/v;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lm/t;Ljava/lang/String;Lm/s;Lm/v;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lm/y$a;
    ...
    invoke-virtual {p1, v0, v1}, Lm/y$a;->h(Ljava/lang/Class;Ljava/lang/Object;)Lm/y$a;
