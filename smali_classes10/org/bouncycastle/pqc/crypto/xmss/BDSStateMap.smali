...
.method public constructor <init>(Lo/a/g/b/i/o;J[B[B)V
    .locals 11
    ...
    invoke-virtual {p1}, Lo/a/g/b/i/o;->a()I
    ...
    invoke-virtual/range {v0 .. v5}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->updateState(Lo/a/g/b/i/o;J[B[B)V
...
.method public get(I)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    ...
    invoke-static {p1}, Lo/a/h/f;->d(I)Ljava/lang/Integer;
...
.method public update(I[B[BLo/a/g/b/i/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    .locals 3
    ...
    invoke-virtual {p1, p2, p3, p4}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->getNextState([B[BLo/a/g/b/i/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
...
.method public updateState(Lo/a/g/b/i/o;J[B[B)V
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Lo/a/g/b/i/o;->h()Lo/a/g/b/i/t;
    ...
    invoke-static {v1, v2, v6}, Lo/a/g/b/i/w;->j(JI)J

    move-result-wide v7

    invoke-static {v1, v2, v6}, Lo/a/g/b/i/w;->i(JI)I

    move-result v9

    new-instance v10, Lo/a/g/b/i/g$b;

    invoke-direct {v10}, Lo/a/g/b/i/g$b;-><init>()V

    invoke-virtual {v10, v7, v8}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;

    move-result-object v10

    check-cast v10, Lo/a/g/b/i/g$b;

    invoke-virtual {v10, v9}, Lo/a/g/b/i/g$b;->p(I)Lo/a/g/b/i/g$b;

    move-result-object v10

    invoke-virtual {v10}, Lo/a/g/b/i/g$b;->l()Lo/a/g/b/i/l;

    move-result-object v10

    check-cast v10, Lo/a/g/b/i/g;
    ...
    invoke-direct {v9, v5, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lo/a/g/b/i/t;[B[BLo/a/g/b/i/g;)V

    invoke-virtual {v0, v13, v9}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->put(ILorg/bouncycastle/pqc/crypto/xmss/BDS;)V

    :cond_1
    invoke-virtual {v0, v13, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->update(I[B[BLo/a/g/b/i/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;

    :cond_2
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lo/a/g/b/i/o;->b()I

    move-result v9

    if-ge v11, v9, :cond_6

    invoke-static {v7, v8, v6}, Lo/a/g/b/i/w;->i(JI)I

    move-result v9

    invoke-static {v7, v8, v6}, Lo/a/g/b/i/w;->j(JI)J
    ...
    invoke-virtual {v10, v11}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;
    ...
    invoke-static {v1, v2, v6, v11}, Lo/a/g/b/i/w;->n(JII)Z
    ...
    invoke-direct {v15, v5, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lo/a/g/b/i/t;[B[BLo/a/g/b/i/g;)V
    ...
    invoke-static {v1, v2, v6, v11}, Lo/a/g/b/i/w;->m(JII)Z

    move-result v9

    if-eqz v9, :cond_5

    invoke-virtual {v0, v11, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->update(I[B[BLo/a/g/b/i/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
...
.method public withWOTSDigest(Lo/a/a/u;)Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;
    .locals 5
    ...
    invoke-virtual {v4, p1}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->withWOTSDigest(Lo/a/a/u;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
