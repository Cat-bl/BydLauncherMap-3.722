.class public Lcn/hutool/core/convert/impl/EntryConverter;
...
.method public constructor <init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcn/hutool/core/convert/impl/EntryConverter;-><init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
...
.method public constructor <init>(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;)V
    ...
    iput-object p1, p0, Lcn/hutool/core/convert/impl/EntryConverter;->pairType:Ljava/lang/reflect/Type;

    iput-object p2, p0, Lcn/hutool/core/convert/impl/EntryConverter;->keyType:Ljava/lang/reflect/Type;

    iput-object p3, p0, Lcn/hutool/core/convert/impl/EntryConverter;->valueType:Ljava/lang/reflect/Type;

    return-void
.end method

.method private static mapToEntry(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/util/Map;)Ljava/util/Map$Entry;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic convertInternal(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcn/hutool/core/convert/impl/EntryConverter;->convertInternal(Ljava/lang/Object;)Ljava/util/Map$Entry;
...
.method public convertInternal(Ljava/lang/Object;)Ljava/util/Map$Entry;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    instance-of v0, p1, Lcn/hutool/core/lang/Pair;
    ...
    check-cast v0, Lcn/hutool/core/lang/Pair;
    ...
    invoke-static {v0}, Lcn/hutool/core/convert/impl/EntryConverter;->strToMap(Ljava/lang/CharSequence;)Ljava/util/Map;
    ...
    iget-object p1, p0, Lcn/hutool/core/convert/impl/EntryConverter;->pairType:Ljava/lang/reflect/Type;

    iget-object v1, p0, Lcn/hutool/core/convert/impl/EntryConverter;->keyType:Ljava/lang/reflect/Type;

    iget-object v2, p0, Lcn/hutool/core/convert/impl/EntryConverter;->valueType:Ljava/lang/reflect/Type;

    invoke-static {p1, v1, v2, v0}, Lcn/hutool/core/convert/impl/EntryConverter;->mapToEntry(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/util/Map;)Ljava/util/Map$Entry;
