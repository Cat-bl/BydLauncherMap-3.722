...
.method private synthetic lambda$checkValue$0(I)Lcn/hutool/cron/CronException;
    .locals 4
...
# virtual methods
.method public synthetic a(I)Lcn/hutool/cron/CronException;
    .locals 0

    invoke-direct {p0, p1}, Lcn/hutool/cron/pattern/Part;->lambda$checkValue$0(I)Lcn/hutool/cron/CronException;
...
.method public checkValue(I)I
    ...
    new-instance v2, Le/a/e/e/a;

    invoke-direct {v2, p0, p1}, Le/a/e/e/a;-><init>(Lcn/hutool/cron/pattern/Part;I)V

    invoke-static {p1, v0, v1, v2}, Le/a/d/n/r;->a(IIILjava/util/function/Supplier;)I
