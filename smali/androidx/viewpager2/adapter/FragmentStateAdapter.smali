...
.method public constructor <init>(Landroidx/fragment/app/FragmentManager;Landroidx/lifecycle/Lifecycle;)V
    ...
    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    new-instance v0, Lc/d/d;

    invoke-direct {v0}, Lc/d/d;-><init>()V

    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;

    new-instance v0, Lc/d/d;

    invoke-direct {v0}, Lc/d/d;-><init>()V

    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;
...
# virtual methods
.method public final A(Landroid/view/ViewGroup;I)Lc/d0/a/a;
    .locals 0

    invoke-static {p1}, Lc/d0/a/a;->a(Landroid/view/ViewGroup;)Lc/d0/a/a;
...
.method public final D(Lc/d0/a/a;)Z
    .locals 0
...
.method public final F(Lc/d0/a/a;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->I(Lc/d0/a/a;)V
...
.method public final G(Lc/d0/a/a;)V
    .locals 3
    ...
    invoke-virtual {p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->y(I)Ljava/lang/Long;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->K(J)V

    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;

    invoke-virtual {p1}, Ljava/lang/Long;->longValue()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lc/d/d;->m(J)V

    :cond_0
    return-void
.end method

.method public I(Lc/d0/a/a;)V
    .locals 5

    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->getItemId()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lc/d/d;->g(J)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v3, v2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->i(Landroid/view/View;Landroid/widget/FrameLayout;)V
    ...
    :cond_5
    invoke-virtual {p0}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->Q()Z
    ...
    invoke-virtual {v1, v0, p1}, Lc/m/a/s;->e(Landroidx/fragment/app/Fragment;Ljava/lang/String;)Lc/m/a/s;

    move-result-object p1

    sget-object v1, Landroidx/lifecycle/Lifecycle$State;->STARTED:Landroidx/lifecycle/Lifecycle$State;

    invoke-virtual {p1, v0, v1}, Lc/m/a/s;->w(Landroidx/fragment/app/Fragment;Landroidx/lifecycle/Lifecycle$State;)Lc/m/a/s;

    move-result-object p1

    invoke-virtual {p1}, Lc/m/a/s;->l()V
    ...
    invoke-direct {v1, p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter$2;-><init>(Landroidx/viewpager2/adapter/FragmentStateAdapter;Lc/d0/a/a;)V
...
.method public final K(J)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->j(J)Z

    move-result v1

    if-nez v1, :cond_2

    iget-object v1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;

    invoke-virtual {v1, p1, p2}, Lc/d/d;->m(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lc/d/d;->m(J)V
    ...
    invoke-virtual {v1, p1, p2, v2}, Lc/d/d;->l(JLjava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lc/m/a/s;->s(Landroidx/fragment/app/Fragment;)Lc/m/a/s;
...
.method public final L()V
    ...
    invoke-virtual {v2, v3}, Landroidx/lifecycle/Lifecycle;->a(Lc/o/k;)V
...
.method public final O(Landroidx/fragment/app/Fragment;Landroid/widget/FrameLayout;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/fragment/app/FragmentManager;->e1(Landroidx/fragment/app/FragmentManager$l;Z)V
...
.method public final a()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    invoke-virtual {v1}, Lc/d/d;->o()I

    move-result v1

    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;
    ...
    :goto_0
    iget-object v3, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;
    ...
    invoke-virtual {v3, v2}, Lc/d/d;->k(I)J

    move-result-wide v3

    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    invoke-virtual {v5, v3, v4}, Lc/d/d;->g(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v1}, Lc/d/d;->k(I)J

    move-result-wide v2

    invoke-virtual {p0, v2, v3}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->j(J)Z
    ...
    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;

    invoke-virtual {v5, v2, v3}, Lc/d/d;->g(J)Ljava/lang/Object;
...
.method public final f(Landroid/os/Parcelable;)V
    ...
    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;

    invoke-virtual {v0}, Lc/d/d;->j()Z
    ...
    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    :goto_1
    invoke-virtual {v4, v2, v3, v1}, Lc/d/d;->l(JLjava/lang/Object;)V
    ...
    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->d:Lc/d/d;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    invoke-virtual {p1}, Lc/d/d;->j()Z
    ...
    invoke-virtual {p0}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->L()V
...
.method public i(Landroid/view/View;Landroid/widget/FrameLayout;)V
    .locals 2
...
.method public onAttachedToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :goto_0
    invoke-static {v0}, Lc/g/i/h;->a(Z)V
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    check-cast p1, Lc/d0/a/a;

    invoke-virtual {p0, p1, p2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->z(Lc/d0/a/a;I)V
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->A(Landroid/view/ViewGroup;I)Lc/d0/a/a;
...
.method public bridge synthetic onFailedToRecycleView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->D(Lc/d0/a/a;)Z
...
.method public bridge synthetic onViewAttachedToWindow(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->F(Lc/d0/a/a;)V
...
.method public bridge synthetic onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->G(Lc/d0/a/a;)V
...
.method public final q(I)V
    ...
    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->c:Lc/d/d;

    invoke-virtual {v2, v0, v1}, Lc/d/d;->e(J)Z
    ...
    invoke-virtual {v2, v0, v1}, Lc/d/d;->g(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0, v1, p1}, Lc/d/d;->l(JLjava/lang/Object;)V
...
.method public t()V
    ...
    invoke-virtual {p0, v3, v4}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->j(J)Z
    ...
    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;

    invoke-virtual {v5, v3, v4}, Lc/d/d;->m(J)V
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->u(J)Z
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->K(J)V
...
.method public final u(J)Z
    ...
    invoke-virtual {v0, p1, p2}, Lc/d/d;->e(J)Z
...
.method public final y(I)Ljava/lang/Long;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;
    ...
    invoke-virtual {v2, v1}, Lc/d/d;->p(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Lc/d/d;->k(I)J
...
.method public final z(Lc/d0/a/a;I)V
    .locals 7
    ...
    invoke-virtual {p0, v2}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->y(I)Ljava/lang/Long;
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->K(J)V

    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;

    invoke-virtual {v3}, Ljava/lang/Long;->longValue()J

    move-result-wide v5

    invoke-virtual {v4, v5, v6}, Lc/d/d;->m(J)V

    :cond_0
    iget-object v3, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->e:Lc/d/d;

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v3, v0, v1, v2}, Lc/d/d;->l(JLjava/lang/Object;)V
    ...
    invoke-static {p2}, Lc/g/j/e0;->V(Landroid/view/View;)Z
    ...
    invoke-direct {v0, p0, p2, p1}, Landroidx/viewpager2/adapter/FragmentStateAdapter$a;-><init>(Landroidx/viewpager2/adapter/FragmentStateAdapter;Landroid/widget/FrameLayout;Lc/d0/a/a;)V
