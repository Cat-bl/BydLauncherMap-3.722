.class public Landroid/media/Cea708CCWidget$CCWindowLayout;
...
.method public initWindow(Landroid/media/Cea708CCWidget$CCLayout;Landroid/media/Cea708CCParser$CaptionWindow;)V
    ...
    iget v2, p2, Landroid/media/Cea708CCParser$CaptionWindow;->anchorHorizontal:I
    ...
    const-string v4, "The vertical position of the anchor point should be at the range of 0 and 1 but "
    ...
    const-string v4, "The horizontal position of the anchor point should be at the range of 0 and 1 but "
    ...
    iget v4, p2, Landroid/media/Cea708CCParser$CaptionWindow;->anchorId:I
    ...
    iget-object v5, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mCCView:Landroid/media/Cea708CCWidget$CCView;
    ...
    iget v5, p2, Landroid/media/Cea708CCParser$CaptionWindow;->columnCount:I
    ...
    iget-object v11, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mWidestChar:Ljava/lang/String;
    ...
    iget-object v10, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mCaptionStyle:Landroid/view/accessibility/CaptioningManager$CaptionStyle;
    ...
    invoke-virtual {v1, v9}, Landroid/media/Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    invoke-direct {v4, v0, v3, v2, v5}, Landroid/media/Cea708CCWidget$ScaledLayout$ScaledLayoutParams;-><init>(FFFF)V

    invoke-virtual {p1, p0, v4}, Landroid/media/Cea708CCWidget$CCLayout;->addOrUpdateViewToSafeTitleArea(Landroid/media/Cea708CCWidget$CCWindowLayout;Landroid/media/Cea708CCWidget$ScaledLayout$ScaledLayoutParams;)V
