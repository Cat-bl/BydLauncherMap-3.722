...
.method public static synthetic access$100()F
    .locals 1
...
.method public static synthetic access$200(Landroid/media/audiofx/DynamicsProcessing;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic access$300(Landroid/media/audiofx/DynamicsProcessing;)Landroid/media/audiofx/DynamicsProcessing$OnParameterChangeListener;
    .locals 0
...
.method private byteArrayToNumberArray([B[Ljava/lang/Number;)V
    ...
    invoke-static {p1, v0}, Landroid/media/audiofx/AudioEffect;->byteArrayToInt([BI)I
    ...
    invoke-static {p1, v0}, Landroid/media/audiofx/AudioEffect;->byteArrayToFloat([BI)F
    ...
    const-string v2, "only converted "
...
.method private getOneInt(I)I
    ...
    invoke-virtual {p0, v1, p1}, Landroid/media/audiofx/AudioEffect;->getParameter([I[I)I
...
.method private getTwoFloat(II)F
    ...
    invoke-virtual {p0, v0, p1}, Landroid/media/audiofx/AudioEffect;->getParameter([I[B)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/media/audiofx/AudioEffect;->checkStatus(I)V

    invoke-static {p1}, Landroid/media/audiofx/AudioEffect;->byteArrayToFloat([B)F
...
.method private queryEngineByChannelIndex(I)Landroid/media/audiofx/DynamicsProcessing$Channel;
    ...
    invoke-virtual {v10}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z

    move-result v3

    invoke-virtual {v10}, Landroid/media/audiofx/DynamicsProcessing$BandStage;->getBandCount()I

    move-result v4

    invoke-virtual {v11}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z

    move-result v5

    invoke-virtual {v11}, Landroid/media/audiofx/DynamicsProcessing$BandStage;->getBandCount()I

    move-result v6

    invoke-virtual {v12}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z

    move-result v7

    invoke-virtual {v12}, Landroid/media/audiofx/DynamicsProcessing$BandStage;->getBandCount()I

    move-result v8

    invoke-virtual {p1}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z
...
.method private queryEngineEqByChannelIndex(II)Landroid/media/audiofx/DynamicsProcessing$Eq;
    ...
    invoke-virtual {p0, v1, v6}, Landroid/media/audiofx/AudioEffect;->getParameter([B[B)I
...
.method private queryEngineLimiterByChannelIndex(I)Landroid/media/audiofx/DynamicsProcessing$Limiter;
    ...
    invoke-virtual {v0, v2, v5}, Landroid/media/audiofx/AudioEffect;->getParameter([B[B)I
...
.method private queryEngineMbcBandByChannelIndex(II)Landroid/media/audiofx/DynamicsProcessing$MbcBand;
    ...
    invoke-virtual {v0, v2, v7}, Landroid/media/audiofx/AudioEffect;->getParameter([B[B)I
...
.method private queryEngineMbcByChannelIndex(I)Landroid/media/audiofx/DynamicsProcessing$Mbc;
    ...
    invoke-virtual {p0, v1, v4}, Landroid/media/audiofx/AudioEffect;->getParameter([B[B)I
...
.method private setTwoFloat(IIF)V
    ...
    invoke-static {p3}, Landroid/media/audiofx/AudioEffect;->floatToByteArray(F)[B

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Landroid/media/audiofx/AudioEffect;->setParameter([I[B)I
...
.method private updateEngineEqBandByChannelIndex(IIILandroid/media/audiofx/DynamicsProcessing$EqBand;)V
    ...
    invoke-virtual {p4}, Landroid/media/audiofx/DynamicsProcessing$BandBase;->isEnabled()Z
    ...
    invoke-virtual {p4}, Landroid/media/audiofx/DynamicsProcessing$BandBase;->getCutoffFrequency()F
...
.method private updateEngineEqByChannelIndex(IILandroid/media/audiofx/DynamicsProcessing$Eq;)V
    ...
    invoke-virtual {p3}, Landroid/media/audiofx/DynamicsProcessing$BandStage;->getBandCount()I
    ...
    invoke-virtual {p3}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z
    ...
    invoke-virtual {p3}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isEnabled()Z
...
.method private updateEngineLimiterByChannelIndex(ILandroid/media/audiofx/DynamicsProcessing$Limiter;)V
    ...
    invoke-virtual {p2}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isInUse()Z
    ...
    invoke-virtual {p2}, Landroid/media/audiofx/DynamicsProcessing$Stage;->isEnabled()Z
...
.method private updateEngineMbcBandByChannelIndex(IILandroid/media/audiofx/DynamicsProcessing$MbcBand;)V
    ...
    invoke-virtual {p3}, Landroid/media/audiofx/DynamicsProcessing$BandBase;->isEnabled()Z
    ...
    invoke-virtual {p3}, Landroid/media/audiofx/DynamicsProcessing$BandBase;->getCutoffFrequency()F
