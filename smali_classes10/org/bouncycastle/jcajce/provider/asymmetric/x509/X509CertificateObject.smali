...
# direct methods
.method public constructor <init>(Lo/a/d/d/b;Lo/a/a/v3/f;)V
    .locals 7
    ...
    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createBasicConstraints(Lo/a/a/v3/f;)Lo/a/a/v3/b;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createKeyUsage(Lo/a/a/v3/f;)[Z

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgName(Lo/a/a/v3/f;)Ljava/lang/String;

    move-result-object v5

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgParams(Lo/a/a/v3/f;)[B
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;-><init>(Lo/a/d/d/b;Lo/a/a/v3/f;Lo/a/a/v3/b;[ZLjava/lang/String;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lo/a/e/c/b;

    return-void
.end method

.method private static createBasicConstraints(Lo/a/a/v3/f;)Lo/a/a/v3/b;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->getExtensionOctets(Lo/a/a/v3/f;Ljava/lang/String;)[B
...
.method private static createKeyUsage(Lo/a/a/v3/f;)[Z
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    invoke-virtual {p0}, Lo/a/a/c;->t()[B
    ...
    invoke-virtual {p0}, Lo/a/a/c;->b()I
...
.method private static createSigAlgName(Lo/a/a/v3/f;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    :try_start_0
    invoke-virtual {p0}, Lo/a/a/v3/f;->n()Lo/a/a/v3/a;
...
.method private static createSigAlgParams(Lo/a/a/v3/f;)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
...
.method private getInternalCertificate()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->bcHelper:Lo/a/d/d/b;

    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lo/a/a/v3/f;

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->basicConstraints:Lo/a/a/v3/b;
    ...
    invoke-direct/range {v3 .. v11}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;-><init>(Lo/a/d/d/b;Lo/a/a/v3/f;Lo/a/a/v3/b;[ZLjava/lang/String;[B[BLjava/security/cert/CertificateEncodingException;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lo/a/a/v3/f;

    invoke-virtual {v2}, Lo/a/a/v3/f;->m()Lo/a/a/c;
...
.method public getBagAttribute(Lo/a/a/u;)Lo/a/a/g;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lo/a/e/c/b;
