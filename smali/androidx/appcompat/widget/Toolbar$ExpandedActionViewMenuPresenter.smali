...
# instance fields
.field public mCurrentExpandedItem:Lc/b/f/j/i;
...
.method public collapseItemActionView(Lc/b/f/j/g;Lc/b/f/j/i;)Z
    ...
    instance-of v0, p1, Lc/b/f/c;

    if-eqz v0, :cond_0

    check-cast p1, Lc/b/f/c;

    invoke-interface {p1}, Lc/b/f/c;->onActionViewCollapsed()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Lc/b/f/j/i;
    ...
    invoke-virtual {p2, p1}, Lc/b/f/j/i;->r(Z)V
...
.method public expandItemActionView(Lc/b/f/j/g;Lc/b/f/j/i;)Z
    ...
    invoke-virtual {p2}, Lc/b/f/j/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->mExpandedActionView:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Lc/b/f/j/i;
    ...
    iput v0, p1, Lc/b/a/f$a;->gravity:I
    ...
    instance-of v0, p2, Lc/b/f/c;

    if-eqz v0, :cond_4

    check-cast p2, Lc/b/f/c;

    invoke-interface {p2}, Lc/b/f/c;->onActionViewExpanded()V
...
.method public initForMenu(Landroid/content/Context;Lc/b/f/j/g;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Lc/b/f/j/g;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Lc/b/f/j/i;

    if-eqz v0, :cond_0

    invoke-virtual {p1, v0}, Lc/b/f/j/g;->collapseItemActionView(Lc/b/f/j/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Lc/b/f/j/g;
...
.method public updateMenuView(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Lc/b/f/j/i;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Lc/b/f/j/g;

    invoke-virtual {v2, v1}, Lc/b/f/j/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Lc/b/f/j/i;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter;->collapseItemActionView(Lc/b/f/j/g;Lc/b/f/j/i;)Z
