...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lc/b/f/j/b;-><init>(Landroid/content/Context;II)V
...
.method public static synthetic access$000(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/g;
    .locals 0

    iget-object p0, p0, Lc/b/f/j/b;->mMenu:Lc/b/f/j/g;

    return-object p0
.end method

.method public static synthetic access$100(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/g;
    .locals 0
...
.method public static synthetic access$200(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/n;
    .locals 0

    iget-object p0, p0, Lc/b/f/j/b;->mMenuView:Lc/b/f/j/n;

    return-object p0
.end method

.method public static synthetic access$300(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/g;
    .locals 0
...
.method public static synthetic access$400(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/g;
    .locals 0
...
.method public static synthetic access$500(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/g;
    .locals 0
...
.method public static synthetic access$600(Landroidx/appcompat/widget/ActionMenuPresenter;)Lc/b/f/j/n;
    .locals 0
...
.method private findViewForItem(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    instance-of v5, v4, Lc/b/f/j/n$a;

    if-eqz v5, :cond_1

    move-object v5, v4

    check-cast v5, Lc/b/f/j/n$a;

    invoke-interface {v5}, Lc/b/f/j/n$a;->getItemData()Lc/b/f/j/i;
...
# virtual methods
.method public bindItemView(Lc/b/f/j/i;Lc/b/f/j/n$a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Lc/b/f/j/n$a;->initialize(Lc/b/f/j/i;I)V
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setItemInvoker(Lc/b/f/j/g$b;)V
...
.method public filterLeftoverView(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lc/b/f/j/b;->filterLeftoverView(Landroid/view/ViewGroup;I)Z
...
.method public flagActionItems()Z
    ...
    iget-object v1, v0, Lc/b/f/j/b;->mMenu:Lc/b/f/j/g;
    ...
    invoke-virtual {v1}, Lc/b/f/j/g;->getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-object v8, v0, Lc/b/f/j/b;->mMenuView:Lc/b/f/j/n;
    ...
    check-cast v14, Lc/b/f/j/i;

    invoke-virtual {v14}, Lc/b/f/j/i;->o()Z
    ...
    :cond_1
    invoke-virtual {v14}, Lc/b/f/j/i;->n()Z
    ...
    invoke-virtual {v14}, Lc/b/f/j/i;->isActionViewExpanded()Z
    ...
    check-cast v15, Lc/b/f/j/i;

    invoke-virtual {v15}, Lc/b/f/j/i;->o()Z

    move-result v16

    if-eqz v16, :cond_b

    invoke-virtual {v0, v15, v2, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Lc/b/f/j/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_9
    invoke-virtual {v15}, Lc/b/f/j/i;->getGroupId()I
    ...
    :cond_a
    invoke-virtual {v15, v13}, Lc/b/f/j/i;->u(Z)V
    ...
    :cond_b
    invoke-virtual {v15}, Lc/b/f/j/i;->n()Z
    ...
    invoke-virtual {v0, v15, v3, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Lc/b/f/j/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast v13, Lc/b/f/j/i;

    invoke-virtual {v13}, Lc/b/f/j/i;->getGroupId()I

    move-result v0

    if-ne v0, v2, :cond_17

    invoke-virtual {v13}, Lc/b/f/j/i;->l()Z
    ...
    invoke-virtual {v13, v0}, Lc/b/f/j/i;->u(Z)V
    ...
    :cond_19
    invoke-virtual {v15, v3}, Lc/b/f/j/i;->u(Z)V
    ...
    invoke-virtual {v15, v0}, Lc/b/f/j/i;->u(Z)V
...
.method public getItemView(Lc/b/f/j/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lc/b/f/j/i;->getActionView()Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Lc/b/f/j/b;->getItemView(Lc/b/f/j/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    :cond_1
    invoke-virtual {p1}, Lc/b/f/j/i;->isActionViewExpanded()Z
...
.method public getMenuView(Landroid/view/ViewGroup;)Lc/b/f/j/n;
    ...
    invoke-super {p0, p1}, Lc/b/f/j/b;->getMenuView(Landroid/view/ViewGroup;)Lc/b/f/j/n;
...
.method public hideOverflowMenu()Z
    ...
    iget-object v2, p0, Lc/b/f/j/b;->mMenuView:Lc/b/f/j/n;
...
.method public initForMenu(Landroid/content/Context;Lc/b/f/j/g;)V
    ...
    invoke-super {p0, p1, p2}, Lc/b/f/j/b;->initForMenu(Landroid/content/Context;Lc/b/f/j/g;)V
    ...
    invoke-virtual {p1}, Lc/b/f/a;->h()Z
    ...
    invoke-virtual {p1}, Lc/b/f/a;->c()I
    ...
    invoke-virtual {p1}, Lc/b/f/a;->d()I
    ...
    iget-object v2, p0, Lc/b/f/j/b;->mSystemContext:Landroid/content/Context;
...
.method public onCloseMenu(Lc/b/f/j/g;Z)V
    ...
    invoke-super {p0, p1, p2}, Lc/b/f/j/b;->onCloseMenu(Lc/b/f/j/g;Z)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lc/b/f/j/b;->mContext:Landroid/content/Context;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, p1}, Lc/b/f/j/g;->findItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionMenuPresenter;->onSubMenuSelected(Lc/b/f/j/r;)Z
...
.method public onSubMenuSelected(Lc/b/f/j/r;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Lc/b/f/j/r;->getParentMenu()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Lc/b/f/j/b;->mMenu:Lc/b/f/j/g;
    ...
    check-cast v0, Lc/b/f/j/r;

    goto :goto_0

    :cond_1
    invoke-virtual {v0}, Lc/b/f/j/r;->getItem()Landroid/view/MenuItem;
    ...
    :cond_2
    invoke-virtual {p1}, Lc/b/f/j/r;->getItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, v3}, Lc/b/f/j/g;->getItem(I)Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Lc/b/f/j/b;->mContext:Landroid/content/Context;

    invoke-direct {v2, p0, v3, p1, v0}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lc/b/f/j/r;Landroid/view/View;)V
    ...
    invoke-virtual {v2, v1}, Lc/b/f/j/l;->setForceShowIcon(Z)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mActionButtonPopup:Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;

    invoke-virtual {v0}, Lc/b/f/j/l;->show()V

    invoke-super {p0, p1}, Lc/b/f/j/b;->onSubMenuSelected(Lc/b/f/j/r;)Z
...
.method public onSubUiVisibilityChanged(Z)V
    ...
    invoke-virtual {p1, v0}, Lc/b/f/j/g;->close(Z)V
...
.method public setMenuView(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->initialize(Lc/b/f/j/g;)V
...
.method public showOverflowMenu()Z
    ...
    iget-object v1, p0, Lc/b/f/j/b;->mMenuView:Lc/b/f/j/n;
    ...
    invoke-virtual {v0}, Lc/b/f/j/g;->getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lc/b/f/j/b;->mMenu:Lc/b/f/j/g;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowPopup;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lc/b/f/j/g;Landroid/view/View;Z)V
...
.method public updateMenuView(Z)V
    ...
    invoke-super {p0, p1}, Lc/b/f/j/b;->updateMenuView(Z)V
    ...
    invoke-virtual {p1}, Lc/b/f/j/g;->getActionItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lc/b/f/j/i;->a()Lc/g/j/g;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Lc/g/j/g;->setSubUiVisibilityListener(Lc/g/j/g$a;)V
    ...
    invoke-virtual {p1}, Lc/b/f/j/g;->getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lc/b/f/j/b;->mSystemContext:Landroid/content/Context;
