...
# instance fields
.field public final a:Lh/a/e0/f/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/a/e0/f/a<",
            "TT;>;"
...
.method public constructor <init>(ILjava/lang/Runnable;Z)V
    ...
    iput-object v0, p0, Lio/reactivex/subjects/UnicastSubject;->a:Lh/a/e0/f/a;
...
.method public static c()Lio/reactivex/subjects/UnicastSubject;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static d(I)Lio/reactivex/subjects/UnicastSubject;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static e(ILjava/lang/Runnable;)Lio/reactivex/subjects/UnicastSubject;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public g()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/subjects/UnicastSubject;->h(Lh/a/u;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/subjects/UnicastSubject;->i(Lh/a/u;)V
...
.method public h(Lh/a/u;)V
    ...
    iget-object v0, p0, Lio/reactivex/subjects/UnicastSubject;->a:Lh/a/e0/f/a;
    ...
    invoke-virtual {p0, v0, p1}, Lio/reactivex/subjects/UnicastSubject;->k(Lh/a/e0/c/h;Lh/a/u;)Z
    ...
    :cond_2
    invoke-interface {p1, v4}, Lh/a/u;->onNext(Ljava/lang/Object;)V

    if-eqz v3, :cond_3

    invoke-virtual {p0, p1}, Lio/reactivex/subjects/UnicastSubject;->j(Lh/a/u;)V
...
.method public i(Lh/a/u;)V
    ...
    iget-object v6, p0, Lio/reactivex/subjects/UnicastSubject;->a:Lh/a/e0/f/a;

    invoke-virtual {v6}, Lh/a/e0/f/a;->poll()Ljava/lang/Object;
    ...
    :cond_6
    invoke-interface {p1, v6}, Lh/a/u;->onNext(Ljava/lang/Object;)V

    goto :goto_0
.end method

.method public j(Lh/a/u;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public k(Lh/a/e0/c/h;Lh/a/u;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v0}, Lh/a/u;->onError(Ljava/lang/Throwable;)V
