...
.method public constructor <init>(Lf/h/p/m/d3;Lcom/autosdk/bussiness/search/SearchLifeCycleOwner;)V
    ...
    iput-object p1, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;

    invoke-static {v0}, Lf/h/p/m/d3;->m0(Lf/h/p/m/d3;)Lf/h/i/c/l;
    ...
    invoke-static {v0}, Lf/h/p/m/d3;->n0(Lf/h/p/m/d3;)Lf/h/i/c/l;
...
.method public onFailure(ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;

    iget-object p2, p1, Lf/h/p/m/d3;->c:Lcom/autosdk/bussiness/search/request/SearchRequestInfo;

    invoke-static {p1}, Lf/h/p/m/d3;->c0(Lf/h/p/m/d3;)I
    ...
    invoke-static {p1}, Lf/h/p/m/d3;->k0(Lf/h/p/m/d3;)Lf/h/i/c/l;
    ...
    invoke-static {p1}, Lf/h/p/m/d3;->l0(Lf/h/p/m/d3;)Lf/h/i/c/l;
    ...
    invoke-virtual {p1, p2}, Lcom/autosdk/search/view/SearchResultLiteView;->i1(Z)V
...
.method public onSuccess(Lcom/autonavi/gbl/search/model/SearchKeywordResult;)V
    ...
    iget-object v1, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;
    ...
    const-string v4, "===loadData loadDataOnLoadMore onSuccess:request page:{?} ClassifySize:{?}"
    ...
    invoke-static {v1}, Lf/h/p/m/d3;->i0(Lf/h/p/m/d3;)Lf/h/i/c/l;
    ...
    invoke-static {v1}, Lf/h/p/m/d3;->j0(Lf/h/p/m/d3;)Lf/h/i/c/l;

    move-result-object v1

    check-cast v1, Lcom/autosdk/search/view/SearchResultLiteView;

    invoke-virtual {v1, v3}, Lcom/autosdk/search/view/SearchResultLiteView;->i1(Z)V

    :cond_1
    iget-object v1, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;

    invoke-static {v1}, Lf/h/p/m/d3;->Y(Lf/h/p/m/d3;)Lf/h/p/k/j;
    ...
    iget-object v1, v1, Lf/h/p/m/d3;->a:Lcom/autosdk/search/view/adapter/SearchResultLiteAdapter;

    invoke-virtual {v1, p1}, Lcom/autosdk/search/view/adapter/SearchResultLiteAdapter;->updateData(Ljava/util/List;)V
    ...
    iget-object v1, p1, Lf/h/p/m/d3;->c:Lcom/autosdk/bussiness/search/request/SearchRequestInfo;

    invoke-static {p1}, Lf/h/p/m/d3;->c0(Lf/h/p/m/d3;)I

    move-result p1

    invoke-virtual {v1, p1}, Lcom/autosdk/bussiness/search/request/SearchRequestInfo;->setPage(I)V
    ...
    invoke-static {p1}, Lf/h/p/m/d3;->a0(Lf/h/p/m/d3;)I
    ...
    invoke-virtual {p1, v1}, Lcom/autosdk/search/presenter/BaseSearchPresenter;->showShortToast(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lf/h/p/m/d3$c;->a:Lf/h/p/m/d3;

    iget-object v2, v2, Lf/h/p/m/d3;->c:Lcom/autosdk/bussiness/search/request/SearchRequestInfo;

    invoke-virtual {v2}, Lcom/autosdk/bussiness/search/request/SearchRequestInfo;->getSize()I

    move-result v2

    invoke-virtual {v1, v0, v2}, Lf/h/p/k/j;->p0(II)Z
...
.method public bridge synthetic onSuccess(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lf/h/p/m/d3$c;->onSuccess(Lcom/autonavi/gbl/search/model/SearchKeywordResult;)V
