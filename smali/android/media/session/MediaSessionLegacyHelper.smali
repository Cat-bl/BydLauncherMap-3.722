...
.method public static synthetic access$000(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/content/Intent;)V
    .locals 0
...
.method public static synthetic access$200(Landroid/media/session/MediaSessionLegacyHelper;)Landroid/util/ArrayMap;
    .locals 0
...
.method public addMediaButtonListener(Landroid/app/PendingIntent;Landroid/content/ComponentName;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/media/session/MediaSessionLegacyHelper;->getHolder(Landroid/app/PendingIntent;Z)Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;
    ...
    iget p3, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mFlags:I

    or-int/2addr p2, p3

    iput p2, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mFlags:I

    iget-object p3, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mSession:Landroid/media/session/MediaSession;

    invoke-virtual {p3, p2}, Landroid/media/session/MediaSession;->setFlags(I)V

    iget-object p2, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mSession:Landroid/media/session/MediaSession;

    invoke-virtual {p2, p1}, Landroid/media/session/MediaSession;->setMediaButtonReceiver(Landroid/app/PendingIntent;)V
...
.method public addRccListener(Landroid/app/PendingIntent;Landroid/media/session/MediaSession$Callback;)V
    ...
    iget p2, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mFlags:I
    ...
    invoke-virtual {v1, p2}, Landroid/media/session/MediaSession;->setFlags(I)V
    ...
    const-string v0, "Added rcc listener for "
...
.method public removeMediaButtonListener(Landroid/app/PendingIntent;)V
    ...
    iget-object v2, v0, Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;->mSession:Landroid/media/session/MediaSession;
...
.method public sendMediaButtonEvent(Landroid/view/KeyEvent;Z)V
    ...
    const-string v0, "dispatched media key "
