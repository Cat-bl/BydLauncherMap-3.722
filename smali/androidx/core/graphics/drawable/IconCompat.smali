...
.method public static h(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    .locals 9
...
.method public static i(Landroid/net/Uri;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {p0}, Lc/g/i/c;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static o(Landroid/content/res/Resources;Ljava/lang/String;I)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {p1}, Lc/g/i/c;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static s(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    .locals 3
...
.method public e(Landroid/content/Context;)V
    ...
    :cond_1
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->r()Ljava/lang/String;

    move-result-object v2

    invoke-static {p1, v2}, Landroidx/core/graphics/drawable/IconCompat;->s(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method public p()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/drawable/IconCompat;->h(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->q()I
...
.method public v(Landroid/content/Context;)Ljava/io/InputStream;
    .locals 3
...
.method public w(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->x(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public final x(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    .locals 5
    ...
    :pswitch_0
    invoke-virtual {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->v(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {v0, v2}, Landroidx/core/graphics/drawable/IconCompat;->h(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Landroidx/core/graphics/drawable/IconCompat;->h(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    :cond_1
    invoke-static {p1, v0}, Landroidx/core/graphics/drawable/IconCompat;->s(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    invoke-static {v0, v3, p1}, Lc/g/b/e/j;->e(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
