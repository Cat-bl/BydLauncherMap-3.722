...
# direct methods
.method public constructor <init>(Lo/g/c;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Lo/g/c;II)V
...
.method public drainLoop()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lo/g/c;
    ...
    invoke-interface {v3, v12}, Lo/g/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v4, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lh/a/e0/c/g;

    if-eqz v13, :cond_5

    invoke-interface {v13}, Lh/a/e0/c/g;->poll()Ljava/lang/Object;

    move-result-object v13

    if-eqz v13, :cond_5

    invoke-interface {v3, v13}, Lo/g/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v13, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lh/a/e0/c/g;

    if-eqz v13, :cond_c

    invoke-interface {v13}, Lh/a/e0/c/h;->isEmpty()Z
...
.method public onNext(Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lo/g/c;
    ...
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()Lh/a/e0/c/g;
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lo/g/c;
