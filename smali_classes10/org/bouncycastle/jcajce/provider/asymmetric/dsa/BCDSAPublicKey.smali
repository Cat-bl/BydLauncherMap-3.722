...
.field private transient lwKeyParams:Lo/a/b/s/k;
...
.method public constructor <init>(Ljava/security/interfaces/DSAPublicKey;)V
    ...
    invoke-static {v1}, Lo/a/d/b/a/b/a;->c(Ljava/security/interfaces/DSAParams;)Lo/a/b/s/i;

    move-result-object v1

    invoke-direct {p1, v0, v1}, Lo/a/b/s/k;-><init>(Ljava/math/BigInteger;Lo/a/b/s/i;)V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->lwKeyParams:Lo/a/b/s/k;
...
.method public constructor <init>(Lo/a/a/v3/r;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->isNotNull(Lo/a/a/g;)Z
    ...
    invoke-static {p1}, Lo/a/a/v3/h;->j(Ljava/lang/Object;)Lo/a/a/v3/h;

    move-result-object p1

    new-instance v0, Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {p1}, Lo/a/a/v3/h;->k()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p1}, Lo/a/a/v3/h;->l()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, Lo/a/a/v3/h;->i()Ljava/math/BigInteger;
...
.method public constructor <init>(Lo/a/b/s/k;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-virtual {p1}, Lo/a/b/s/k;->c()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3}, Lo/a/b/s/i;->a()Ljava/math/BigInteger;
...
.method private isNotNull(Lo/a/a/g;)Z
    .locals 1
...
# virtual methods
.method public engineGetKeyParameters()Lo/a/b/s/k;
    .locals 1

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->lwKeyParams:Lo/a/b/s/k;
...
.method public getEncoded()[B
    ...
    invoke-direct {v3, v0, v4, v5}, Lo/a/a/v3/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-virtual {v3}, Lo/a/a/v3/h;->d()Lo/a/a/y;
