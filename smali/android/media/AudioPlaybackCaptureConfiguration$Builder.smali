...
.method public constructor <init>(Landroid/media/projection/MediaProjection;)V
    ...
    new-instance p1, Landroid/media/audiopolicy/AudioMixingRule$Builder;

    invoke-direct {p1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;-><init>()V

    iput-object p1, p0, Landroid/media/AudioPlaybackCaptureConfiguration$Builder;->mAudioMixingRuleBuilder:Landroid/media/audiopolicy/AudioMixingRule$Builder;
...
.method public addMatchingUid(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, v2, p1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->addMixRule(ILjava/lang/Object;)Landroid/media/audiopolicy/AudioMixingRule$Builder;
...
.method public addMatchingUsage(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, p1, v1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->addRule(Landroid/media/AudioAttributes;I)Landroid/media/audiopolicy/AudioMixingRule$Builder;
...
.method public excludeUid(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, v1, p1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->excludeMixRule(ILjava/lang/Object;)Landroid/media/audiopolicy/AudioMixingRule$Builder;

    const/4 p1, 0x2

    iput p1, p0, Landroid/media/AudioPlaybackCaptureConfiguration$Builder;->mUidMatchType:I
...
.method public excludeUsage(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, p1, v1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->excludeRule(Landroid/media/AudioAttributes;I)Landroid/media/audiopolicy/AudioMixingRule$Builder;

    const/4 p1, 0x2

    iput p1, p0, Landroid/media/AudioPlaybackCaptureConfiguration$Builder;->mUsageMatchType:I
