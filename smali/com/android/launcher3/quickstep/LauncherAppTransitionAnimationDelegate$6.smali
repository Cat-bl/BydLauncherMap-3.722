.class public Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;
...
.method public constructor <init>(Landroid/animation/Animator;[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;[Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams;Lcom/android/launcher3/quickstep/surface/SurfaceTransactionApplier;)V
    ...
    iput-object p1, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$defaultAnimator:Landroid/animation/Animator;

    iput-object p2, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$appTargets:[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;

    iput-object p3, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$params:[Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams;

    iput-object p4, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$surfaceApplier:Lcom/android/launcher3/quickstep/surface/SurfaceTransactionApplier;
...
.method public onUpdate(FFF)V
    ...
    iget-object p1, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$defaultAnimator:Landroid/animation/Animator;
    ...
    :goto_0
    iget-object p3, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$appTargets:[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;
    ...
    iget-object v1, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$appTargets:[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;
    ...
    invoke-virtual {p3, v1}, Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams$Builder;->withVisibility(Z)Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams$Builder;

    :goto_1
    iget-object p3, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$params:[Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams;
    ...
    const-string/jumbo p2, "scheduleApply-show3DCloseAnim"

    invoke-virtual {p1, p2}, Lcom/android/launcher3/quickstep/util/TraceHelper;->beginSection(Ljava/lang/String;)Ljava/lang/Object;

    iget-object p1, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$surfaceApplier:Lcom/android/launcher3/quickstep/surface/SurfaceTransactionApplier;

    iget-object p3, p0, Lcom/android/launcher3/quickstep/LauncherAppTransitionAnimationDelegate$6;->val$params:[Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams;

    invoke-virtual {p1, p3}, Lcom/android/launcher3/quickstep/surface/SurfaceTransactionApplier;->scheduleApply([Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams;)V

    sget-object p1, Lcom/android/launcher3/quickstep/util/TraceHelper;->INSTANCE:Lcom/android/launcher3/quickstep/util/TraceHelper;

    invoke-virtual {p1, p2}, Lcom/android/launcher3/quickstep/util/TraceHelper;->endSection(Ljava/lang/Object;)V
