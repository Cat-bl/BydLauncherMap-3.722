...
# direct methods
.method public constructor <init>(Lh/a/e0/c/a;ILio/reactivex/internal/queue/SpscArrayQueue;Lh/a/v$c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;-><init>(ILio/reactivex/internal/queue/SpscArrayQueue;Lh/a/v$c;)V

    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
...
.method public onSubscribe(Lo/g/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lo/g/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lo/g/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lh/a/e0/c/a;
    ...
    invoke-interface {v3, v15}, Lo/g/c;->onError(Ljava/lang/Throwable;)V

    :goto_2
    iget-object v1, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->worker:Lh/a/v$c;
    ...
    :cond_6
    invoke-interface {v3, v15}, Lh/a/e0/c/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lo/g/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lo/g/d;->request(J)V
