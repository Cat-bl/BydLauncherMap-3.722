...
.method public static constructor <clinit>()V
    ...
    const-string/jumbo v4, "windows nt (10\\.0)"

    invoke-direct {v1, v2, v3, v4}, Lcn/hutool/http/useragent/OS;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "Windows 8.1 or Windows Server 2012R2"

    const-string/jumbo v3, "windows nt 6\\.3"

    const-string/jumbo v4, "windows nt (6\\.3)"
    ...
    const-string v2, "Windows 8 or Windows Server 2012"

    const-string/jumbo v3, "windows nt 6\\.2"

    const-string/jumbo v4, "windows nt (6\\.2)"
    ...
    const-string/jumbo v4, "windows nt (6\\.0)"
    ...
    const-string/jumbo v4, "windows nt (6\\.1)"
    ...
    const-string/jumbo v4, "windows nt (5\\.2)"
    ...
    const-string/jumbo v4, "windows nt (5\\.1)"
    ...
    const-string/jumbo v4, "windows nt (5\\.0)"
    ...
    const-string/jumbo v4, "windows (?:ce|phone|mobile) (\\d+([._]\\d+)*)"
    ...
    const-string v3, "Android (\\d+([._]\\d+)*)"

    invoke-direct {v1, v2, v2, v3}, Lcn/hutool/http/useragent/OS;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "wii libnup/(\\d+([._]\\d+)*)"
    ...
    const-string v4, "playstation 3; (\\d+([._]\\d+)*)"
    ...
    const-string v4, "Portable\\); (\\d+([._]\\d+)*)"
    ...
    const-string v4, "\\(iPhone.*os (\\d+([._]\\d+)*)"
    ...
    const-string v4, "iPod touch[\\s\\;]+iPhone.*os (\\d+([._]\\d+)*)"
    ...
    const-string v4, "iPad[\\s\\;]+iPhone.*os (\\d+([._]\\d+)*)"
    ...
    const-string v4, "iPhone[\\s\\;]+iPhone.*os (\\d+([._]\\d+)*)"
    ...
    const-string/jumbo v3, "symbian(os)?"
