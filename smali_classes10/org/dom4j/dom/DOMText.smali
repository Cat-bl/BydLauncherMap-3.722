...
.method public constructor <init>(Lo/b/i;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/dom4j/tree/DefaultText;-><init>(Lo/b/i;Ljava/lang/String;)V
...
.method public splitText(I)Lorg/w3c/dom/Text;
    ...
    invoke-virtual {p0}, Lorg/dom4j/tree/DefaultText;->getParent()Lo/b/i;

    move-result-object v0

    invoke-virtual {p0, p1}, Lorg/dom4j/dom/DOMText;->createText(Ljava/lang/String;)Lo/b/p;

    move-result-object p1

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Lo/b/i;->add(Lo/b/p;)V
