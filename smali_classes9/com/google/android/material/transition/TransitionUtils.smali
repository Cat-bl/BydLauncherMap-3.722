...
.method public static maybeAddTransition(Lc/a0/s;Lc/a0/o;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lc/a0/s;->g(Lc/a0/o;)Lc/a0/s;

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(Lc/a0/o;Landroid/content/Context;I)Z
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Lc/a0/o;->setDuration(J)Lc/a0/o;
...
.method public static maybeApplyThemeInterpolator(Lc/a0/o;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
...
.method public static maybeApplyThemePath(Lc/a0/o;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Lc/a0/h;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lc/a0/o;->setPathMotion(Lc/a0/h;)V
...
.method public static maybeRemoveTransition(Lc/a0/s;Lc/a0/o;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lc/a0/s;->p(Lc/a0/o;)Lc/a0/s;
...
.method public static resolveThemeInterpolator(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p2, v0, v1, p0}, Lc/g/j/o0/b;->a(FFFF)Landroid/view/animation/Interpolator;
    ...
    invoke-static {p0}, Lc/g/c/f;->e(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-static {p0}, Lc/g/j/o0/b;->b(Landroid/graphics/Path;)Landroid/view/animation/Interpolator;
...
.method public static resolveThemePath(Landroid/content/Context;I)Lc/a0/h;
    .locals 3
    ...
    new-instance p1, Lc/a0/j;

    invoke-static {p0}, Lc/g/c/f;->e(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, Lc/a0/j;-><init>(Landroid/graphics/Path;)V
