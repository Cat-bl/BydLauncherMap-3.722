...
.method public count(Ljava/sql/Connection;Lcn/hutool/db/Entity;)J
    ...
    invoke-static {p2}, Le/a/g/j/f;->f(Lcn/hutool/db/Entity;)Le/a/g/j/f;

    move-result-object p2

    invoke-interface {v0, p1, p2}, Lcn/hutool/db/dialect/Dialect;->psForCount(Ljava/sql/Connection;Le/a/g/j/f;)Ljava/sql/PreparedStatement;
    ...
    invoke-static {p1, p2, v0}, Le/a/g/j/g;->m(Ljava/sql/PreparedStatement;Lcn/hutool/db/handler/RsHandler;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public count(Ljava/sql/Connection;Lcn/hutool/db/sql/SqlBuilder;)J
    ...
    const-string v1, "(.*?)[\\s]order[\\s]by[\\s][^\\s]+\\s(asc|desc)?"

    const/4 v2, 0x2

    invoke-static {v1, v2}, Le/a/d/n/y;->a(Ljava/lang/String;I)Ljava/util/regex/Pattern;
...
.method public del(Ljava/sql/Connection;Lcn/hutool/db/Entity;)I
    ...
    invoke-interface {v3, p1, p2}, Lcn/hutool/db/dialect/Dialect;->psForDelete(Ljava/sql/Connection;Le/a/g/j/f;)Ljava/sql/PreparedStatement;
...
.method public find(Ljava/sql/Connection;Le/a/g/j/f;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-static {p2, v2, v1}, Le/a/d/n/r;->y(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lcn/hutool/db/DialectRunner;->dialect:Lcn/hutool/db/dialect/Dialect;

    invoke-interface {v1, p1, p2}, Lcn/hutool/db/dialect/Dialect;->psForFind(Ljava/sql/Connection;Le/a/g/j/f;)Ljava/sql/PreparedStatement;

    move-result-object p1

    new-array p2, v0, [Ljava/lang/Object;

    invoke-static {p1, p3, p2}, Le/a/g/j/g;->m(Ljava/sql/PreparedStatement;Lcn/hutool/db/handler/RsHandler;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public insert(Ljava/sql/Connection;Lcn/hutool/db/Entity;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_2
    invoke-static {p1, p3}, Le/a/g/f;->d(Ljava/sql/Statement;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Le/a/g/d;->a([Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Le/a/g/d;->a([Ljava/lang/Object;)V
...
.method public page(Ljava/sql/Connection;Lcn/hutool/db/sql/SqlBuilder;Lcn/hutool/db/Page;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, p4}, Le/a/g/j/g;->i(Ljava/sql/Connection;Lcn/hutool/db/sql/SqlBuilder;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    ...
    invoke-static {p1, p4, p2}, Le/a/g/j/g;->m(Ljava/sql/PreparedStatement;Lcn/hutool/db/handler/RsHandler;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public page(Ljava/sql/Connection;Le/a/g/j/f;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcn/hutool/db/DialectRunner;->find(Ljava/sql/Connection;Le/a/g/j/f;Lcn/hutool/db/handler/RsHandler;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2}, Lcn/hutool/db/dialect/Dialect;->psForPage(Ljava/sql/Connection;Le/a/g/j/f;)Ljava/sql/PreparedStatement;
...
.method public update(Ljava/sql/Connection;Lcn/hutool/db/Entity;Lcn/hutool/db/Entity;)I
    ...
    invoke-static {p3}, Le/a/d/o/w;->m(Ljava/util/Map;)Z
    ...
    invoke-static {p3}, Le/a/g/j/i;->b(Lcn/hutool/db/Entity;)[Lcn/hutool/db/sql/Condition;
    ...
    invoke-direct {v1, p3, v3}, Le/a/g/j/f;-><init>([Lcn/hutool/db/sql/Condition;[Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2, v1}, Lcn/hutool/db/dialect/Dialect;->psForUpdate(Ljava/sql/Connection;Lcn/hutool/db/Entity;Le/a/g/j/f;)Ljava/sql/PreparedStatement;
