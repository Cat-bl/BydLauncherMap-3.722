.class public Lcom/antfin/cube/cubecore/component/widget/canvas/CKCanvasWebEventProducer;
...
.method private buildEventData(Ljava/lang/String;Landroid/view/MotionEvent;FFFFFF)Lcom/alibaba/fastjson/JSONObject;
    ...
    invoke-static {v11}, Lf/e/a/d/k/j;->b(F)I
    ...
    invoke-static {v2}, Lf/e/a/d/k/j;->b(F)I
    ...
    invoke-static {v0}, Lf/e/a/d/k/j;->b(F)I

    move-result v0

    int-to-float v3, v0

    invoke-static/range {p5 .. p5}, Lf/e/a/d/k/j;->b(F)I

    move-result v0

    int-to-float v4, v0

    invoke-static/range {p6 .. p6}, Lf/e/a/d/k/j;->b(F)I

    move-result v0

    int-to-float v5, v0

    invoke-static/range {p7 .. p7}, Lf/e/a/d/k/j;->b(F)I

    move-result v0

    int-to-float v6, v0

    invoke-static/range {p8 .. p8}, Lf/e/a/d/k/j;->b(F)I
...
.method private setTapData(Ljava/lang/String;FFFFFF)Lcom/alibaba/fastjson/JSONObject;
    ...
    invoke-static {p1}, Lf/b/a/a;->toJSONString(Ljava/lang/Object;)Ljava/lang/String;
