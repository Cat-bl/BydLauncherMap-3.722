...
.method public constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;)V
    ...
    invoke-direct {p0}, Lc/r/f$c;-><init>()V
...
# virtual methods
.method public onVolumeChanged(Lc/r/f;)V
    .locals 7
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;
    ...
    invoke-virtual {p1}, Lc/r/f;->c()I

    move-result v4

    invoke-virtual {p1}, Lc/r/f;->b()I

    move-result v5

    invoke-virtual {p1}, Lc/r/f;->a()I
