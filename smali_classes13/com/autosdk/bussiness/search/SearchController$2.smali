.class public Lcom/autosdk/bussiness/search/SearchController$2;
...
# instance fields
.field private final suggestionMap:Ljava/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lcom/autosdk/bussiness/search/SearchController;)V
    ...
    iput-object p1, p0, Lcom/autosdk/bussiness/search/SearchController$2;->this$0:Lcom/autosdk/bussiness/search/SearchController;
    ...
    iput-object p1, p0, Lcom/autosdk/bussiness/search/SearchController$2;->suggestionMap:Ljava/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method private synthetic lambda$onGetSuggestionResult$0(IILcom/autonavi/gbl/search/model/SearchSuggestResult;)V
    .locals 3

    iget-object v0, p0, Lcom/autosdk/bussiness/search/SearchController$2;->suggestionMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string p2, "===onGetSuggestionResult searchCallback is null "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object p2, p0, Lcom/autosdk/bussiness/search/SearchController$2;->suggestionMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string p2, "===onGetSuggestionResult remove taskId sparseArray size "
...
# virtual methods
.method public synthetic a(IILcom/autonavi/gbl/search/model/SearchSuggestResult;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/autosdk/bussiness/search/SearchController$2;->lambda$onGetSuggestionResult$0(IILcom/autonavi/gbl/search/model/SearchSuggestResult;)V
...
.method public onGetSuggestionResult(IILcom/autonavi/gbl/search/model/SearchSuggestResult;)V
    ...
    const-string v2, "===onGetSuggestionResult taskid:{?},euRet:{?}"

    invoke-static {v1, v2, v0}, Lcom/autosdk/bussiness/common/utils/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v0, Lf/h/b/m/f;

    invoke-direct {v0, p0, p1, p2, p3}, Lf/h/b/m/f;-><init>(Lcom/autosdk/bussiness/search/SearchController$2;IILcom/autonavi/gbl/search/model/SearchSuggestResult;)V
...
.method public setSearchCallbackWrapper(ILcom/autosdk/bussiness/search/SearchCallback;)V
    ...
    const-string v0, "===onGetSuggestionResult add taskId sparseArray size :{?}"
