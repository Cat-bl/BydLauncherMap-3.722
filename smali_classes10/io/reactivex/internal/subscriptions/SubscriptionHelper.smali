...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    check-cast p0, Lo/g/d;

    if-eq p0, v1, :cond_1

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lo/g/d;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lo/g/d;->request(J)V
    ...
    invoke-static {p1, p2, p3}, Lh/a/e0/i/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lo/g/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lo/g/d;)Z
    ...
    invoke-interface {p2, p0, p1}, Lo/g/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lo/g/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lo/g/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lo/g/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lo/g/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2, p3}, Lo/g/d;->request(J)V
...
.method public static validate(Lo/g/d;Lo/g/d;)Z
    .locals 1
    ...
    invoke-static {p0}, Lh/a/h0/a;->s(Ljava/lang/Throwable;)V
