...
.field public final parent:Lh/a/e0/h/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/a/e0/h/c<",
            "TT;>;"
...
.field public volatile queue:Lh/a/e0/c/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/a/e0/c/h<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Lh/a/e0/h/c;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lh/a/e0/h/c;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lh/a/e0/h/c;

    invoke-interface {v0, p0}, Lh/a/e0/h/c;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1}, Lh/a/e0/h/c;->innerError(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0, p1}, Lh/a/e0/h/c;->innerNext(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Object;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lh/a/e0/h/c;

    invoke-interface {p1}, Lh/a/e0/h/c;->drain()V
...
.method public onSubscribe(Lo/g/d;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lh/a/e0/c/h;

    iput-boolean v2, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lh/a/e0/h/c;

    invoke-interface {p1, p0}, Lh/a/e0/h/c;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public queue()Lh/a/e0/c/h;
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lh/a/e0/c/h;
...
.method public requestOne()V
    ...
    invoke-interface {v2, v0, v1}, Lo/g/d;->request(J)V
