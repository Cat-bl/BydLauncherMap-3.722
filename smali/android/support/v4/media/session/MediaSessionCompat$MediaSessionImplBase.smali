...
.field private mRemoteUserInfo:Lc/r/b;
...
.field private mVolumeCallback:Lc/r/f$c;

.field public mVolumeProvider:Lc/r/f;

.field public mVolumeType:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lc/c0/c;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lc/r/f$c;
    ...
    invoke-direct {p2, p1, p3, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lc/c0/c;)V
...
.method public adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, Lc/r/f;->e(I)V
...
.method public getCurrentControllerInfo()Lc/r/b;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lc/r/b;
...
.method public setCurrentControllerInfo(Lc/r/b;)V
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lc/r/b;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lc/r/f;->g(Lc/r/f$c;)V
...
.method public setPlaybackToRemote(Lc/r/f;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;

    invoke-virtual {v1}, Lc/r/f;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;

    invoke-virtual {v1}, Lc/r/f;->b()I

    move-result v5

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lc/r/f;

    invoke-virtual {v1}, Lc/r/f;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lc/r/f$c;

    invoke-virtual {p1, v0}, Lc/r/f;->g(Lc/r/f$c;)V
...
.method public setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, Lc/r/f;->f(I)V
