...
.field public static final TRANSACTION_applyVirtualDisplayFlags:I = 0x6

.field public static final TRANSACTION_canProjectAudio:I = 0x3

.field public static final TRANSACTION_canProjectSecureVideo:I = 0x5

.field public static final TRANSACTION_canProjectVideo:I = 0x4

.field public static final TRANSACTION_registerCallback:I = 0x7

.field public static final TRANSACTION_start:I = 0x1

.field public static final TRANSACTION_stop:I = 0x2

.field public static final TRANSACTION_unregisterCallback:I = 0x8
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1}, Landroid/media/projection/IMediaProjection;->unregisterCallback(Landroid/media/projection/IMediaProjectionCallback;)V
    ...
    invoke-interface {p0, p1}, Landroid/media/projection/IMediaProjection;->registerCallback(Landroid/media/projection/IMediaProjectionCallback;)V
    ...
    invoke-interface {p0, p1}, Landroid/media/projection/IMediaProjection;->applyVirtualDisplayFlags(I)I
    ...
    invoke-interface {p0}, Landroid/media/projection/IMediaProjection;->canProjectSecureVideo()Z
    ...
    invoke-interface {p0}, Landroid/media/projection/IMediaProjection;->canProjectVideo()Z
    ...
    invoke-interface {p0}, Landroid/media/projection/IMediaProjection;->canProjectAudio()Z
    ...
    invoke-interface {p0}, Landroid/media/projection/IMediaProjection;->stop()V
    ...
    invoke-interface {p0, p1}, Landroid/media/projection/IMediaProjection;->start(Landroid/media/projection/IMediaProjectionCallback;)V
