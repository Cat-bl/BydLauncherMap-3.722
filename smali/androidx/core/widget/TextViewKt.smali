...
# direct methods
.method public static final addTextChangedListener(Landroid/widget/TextView;Lk/w/b/r;Lk/w/b/r;Lk/w/b/l;)Landroid/text/TextWatcher;
    .locals 1
    ...
    invoke-direct {v0, p3, p1, p2}, Landroidx/core/widget/TextViewKt$addTextChangedListener$textWatcher$1;-><init>(Lk/w/b/l;Lk/w/b/r;Lk/w/b/r;)V
...
.method public static synthetic addTextChangedListener$default(Landroid/widget/TextView;Lk/w/b/r;Lk/w/b/r;Lk/w/b/l;ILjava/lang/Object;)Landroid/text/TextWatcher;
    .locals 0
    ...
    invoke-static {p0, p4}, Lk/w/c/r;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p2, p4}, Lk/w/c/r;->f(Ljava/lang/Object;Ljava/lang/String;)V

    const-string p4, "afterTextChanged"

    invoke-static {p3, p4}, Lk/w/c/r;->f(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance p4, Landroidx/core/widget/TextViewKt$addTextChangedListener$textWatcher$1;

    invoke-direct {p4, p3, p1, p2}, Landroidx/core/widget/TextViewKt$addTextChangedListener$textWatcher$1;-><init>(Lk/w/b/l;Lk/w/b/r;Lk/w/b/r;)V
...
.method public static final doAfterTextChanged(Landroid/widget/TextView;Lk/w/b/l;)Landroid/text/TextWatcher;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Landroidx/core/widget/TextViewKt$doAfterTextChanged$$inlined$addTextChangedListener$default$1;-><init>(Lk/w/b/l;)V
...
.method public static final doBeforeTextChanged(Landroid/widget/TextView;Lk/w/b/r;)Landroid/text/TextWatcher;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Landroidx/core/widget/TextViewKt$doBeforeTextChanged$$inlined$addTextChangedListener$default$1;-><init>(Lk/w/b/r;)V
...
.method public static final doOnTextChanged(Landroid/widget/TextView;Lk/w/b/r;)Landroid/text/TextWatcher;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Landroidx/core/widget/TextViewKt$doOnTextChanged$$inlined$addTextChangedListener$default$1;-><init>(Lk/w/b/r;)V
