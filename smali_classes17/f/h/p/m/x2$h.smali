...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lf/h/p/m/x2;->U0(Lcom/autosdk/bussiness/common/GeoPoint;)V
.end annotation
...
.method public constructor <init>(Lf/h/p/m/x2;Z)V
    ...
    iput-object p1, p0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    iput-boolean p2, p0, Lf/h/p/m/x2$h;->a:Z
...
.method public a(Lcom/autosdk/bussiness/navi/route/model/IRouteResultData;Z)V
    ...
    iget-object v2, v0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {v2}, Lf/h/p/m/x2;->o0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    const-string v2, "===startGetCompanyTmcDataAfterHome callback mMvpView is null"
    ...
    iget-object v1, v0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {v1}, Lf/h/p/m/x2;->p0(Lf/h/p/m/x2;)Lf/h/i/c/l;

    move-result-object v1

    check-cast v1, Lf/h/p/o/r7;

    invoke-virtual {v1, v7, v5, v6}, Lf/h/p/o/r7;->D2(Ljava/util/List;J)V

    new-array v1, v4, [Ljava/lang/Object;

    const-string v2, "===startGetCompanyTmcDataAfterHome callback pathResult is null"
    ...
    invoke-static {v1}, Lf/h/p/m/x2;->r0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    const-string v2, "===startGetCompanyTmcDataAfterHome callback pathResult pathCount is Negative"
    ...
    invoke-static {v1}, Lf/h/p/m/x2;->s0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    const-string v2, "===startGetCompanyTmcDataAfterHome callback variantPathWrap is null"
    ...
    iget-object v5, v0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;
    ...
    invoke-virtual {v4, v1}, Lcom/autosdk/search/orientation/bean/SearchHomeOrientationData;->setCompanyTmcData(Lcom/autosdk/search/orientation/bean/SearchHomeOrientationData$TmcEntity;)V
    ...
    const-string v2, "===startGetCompanyTmcDataAfterHome ETASavedTime:{?} "

    invoke-static {v3, v2, v1}, Lcom/autosdk/bussiness/common/utils/Logger;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v1, v0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {v1}, Lf/h/p/m/x2;->t0(Lf/h/p/m/x2;)Lf/h/i/c/l;

    move-result-object v1

    check-cast v1, Lf/h/p/o/r7;

    invoke-virtual {v1, v11, v12, v13}, Lf/h/p/o/r7;->D2(Ljava/util/List;J)V

    iget-boolean v1, v0, Lf/h/p/m/x2$h;->a:Z

    if-eqz v1, :cond_4

    iget-object v1, v0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {v1}, Lf/h/p/m/x2;->u0(Lf/h/p/m/x2;)Lf/h/i/c/l;

    move-result-object v1

    check-cast v1, Lf/h/p/o/r7;

    sget v2, Lcom/autosdk/search/R$string;->search_home_text_company:I
    ...
    invoke-virtual {v1, v2, v4}, Lf/h/p/o/r7;->B2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "[setCompanyData] recycle PathInfos."
...
.method public c()V
    ...
    iget-object v0, p0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {v0}, Lf/h/p/m/x2;->x0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    const-string v2, "===startGetCompanyTmcDataAfterHome weekOrFakeNetCallback mMvpView is null"
    ...
    invoke-static {v0}, Lf/h/p/m/x2;->y0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lf/h/p/o/r7;->D2(Ljava/util/List;J)V
...
.method public errorCallback(ILjava/lang/String;Z)V
    ...
    iget-object p1, p0, Lf/h/p/m/x2$h;->b:Lf/h/p/m/x2;

    invoke-static {p1}, Lf/h/p/m/x2;->v0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    const-string p3, "===startGetCompanyTmcDataAfterHome errorCallback mMvpView is null"
    ...
    invoke-static {p1}, Lf/h/p/m/x2;->w0(Lf/h/p/m/x2;)Lf/h/i/c/l;
    ...
    invoke-virtual {p1, p2, v0, v1}, Lf/h/p/o/r7;->D2(Ljava/util/List;J)V
