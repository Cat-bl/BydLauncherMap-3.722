...
.field public final l4:Landroid/os/Handler;

.field public m4:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field public r4:Landroidx/preference/PreferenceGroup$b;

.field public final s4:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroidx/preference/PreferenceGroup;->k4:Lc/d/g;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Landroidx/preference/PreferenceGroup;->l4:Landroid/os/Handler;

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/preference/PreferenceGroup;->n4:Z

    const/4 v1, 0x0

    iput v1, p0, Landroidx/preference/PreferenceGroup;->o4:I

    iput-boolean v1, p0, Landroidx/preference/PreferenceGroup;->p4:Z

    const v1, 0x7fffffff

    iput v1, p0, Landroidx/preference/PreferenceGroup;->q4:I

    const/4 v2, 0x0

    iput-object v2, p0, Landroidx/preference/PreferenceGroup;->r4:Landroidx/preference/PreferenceGroup$b;
    ...
    iput-object v2, p0, Landroidx/preference/PreferenceGroup;->s4:Ljava/lang/Runnable;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Landroidx/preference/PreferenceGroup;->m4:Ljava/util/List;
    ...
    invoke-static {p1, p2, p2, v0}, Lc/g/b/e/k;->b(Landroid/content/res/TypedArray;IIZ)Z

    move-result p2

    iput-boolean p2, p0, Landroidx/preference/PreferenceGroup;->n4:Z
    ...
    invoke-static {p1, p2, p2, v1}, Lc/g/b/e/k;->d(Landroid/content/res/TypedArray;III)I
...
.method public D0(Landroidx/preference/Preference;)Z
    ...
    iget-object v0, p0, Landroidx/preference/PreferenceGroup;->m4:Ljava/util/List;
    ...
    iget-boolean v0, p0, Landroidx/preference/PreferenceGroup;->n4:Z

    if-eqz v0, :cond_3

    iget v0, p0, Landroidx/preference/PreferenceGroup;->o4:I

    add-int/lit8 v2, v0, 0x1

    iput v2, p0, Landroidx/preference/PreferenceGroup;->o4:I

    invoke-virtual {p1, v0}, Landroidx/preference/Preference;->q0(I)V
    ...
    iget-boolean v2, p0, Landroidx/preference/PreferenceGroup;->n4:Z
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/preference/PreferenceGroup;->m4:Ljava/util/List;
    ...
    iget-object v3, p0, Landroidx/preference/PreferenceGroup;->k4:Lc/d/g;

    invoke-virtual {v3, v2}, Lc/d/g;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Lc/d/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroidx/preference/PreferenceGroup;->k4:Lc/d/g;

    invoke-virtual {v5, v2}, Lc/d/g;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_1

    :cond_7
    invoke-virtual {v0}, Lc/u/j;->f()J

    move-result-wide v3

    :goto_1
    invoke-virtual {p1, v0, v3, v4}, Landroidx/preference/Preference;->O(Lc/u/j;J)V

    invoke-virtual {p1, p0}, Landroidx/preference/Preference;->a(Landroidx/preference/PreferenceGroup;)V

    iget-boolean v0, p0, Landroidx/preference/PreferenceGroup;->p4:Z
...
.method public F0()I
    ...
    iget v0, p0, Landroidx/preference/PreferenceGroup;->q4:I
...
.method public G0()Landroidx/preference/PreferenceGroup$b;
    ...
    iget-object v0, p0, Landroidx/preference/PreferenceGroup;->r4:Landroidx/preference/PreferenceGroup$b;
...
.method public K0(Landroidx/preference/Preference;)Z
    .locals 1
...
.method public L0(I)V
    ...
    :cond_0
    iput p1, p0, Landroidx/preference/PreferenceGroup;->q4:I
...
.method public M()V
    ...
    iput-boolean v0, p0, Landroidx/preference/PreferenceGroup;->p4:Z
...
.method public M0(Z)V
    ...
    iput-boolean p1, p0, Landroidx/preference/PreferenceGroup;->n4:Z
...
.method public W(Landroid/os/Parcelable;)V
    ...
    iput v0, p0, Landroidx/preference/PreferenceGroup;->q4:I
...
.method public X()Landroid/os/Parcelable;
    ...
    iget v2, p0, Landroidx/preference/PreferenceGroup;->q4:I
...
.method public setOnExpandButtonClickListener(Landroidx/preference/PreferenceGroup$b;)V
    ...
    iput-object p1, p0, Landroidx/preference/PreferenceGroup;->r4:Landroidx/preference/PreferenceGroup$b;
