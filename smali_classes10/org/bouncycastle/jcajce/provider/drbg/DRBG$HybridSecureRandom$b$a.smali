...
.method public run()V
    ...
    :catch_0
    :cond_0
    iget v0, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b$a;->a:I
    ...
    :goto_0
    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b$a;->b:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;

    invoke-static {v6}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;->c(Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;)I
    ...
    invoke-virtual {p0, v1, v2}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b$a;->a(J)V

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b$a;->b:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;

    iget-object v6, v6, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;->d:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom;
    ...
    :cond_1
    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b$a;->b:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;

    invoke-static {v5}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;->c(Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;)I
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;->d(Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridSecureRandom$b;)Ljava/util/concurrent/atomic/AtomicReference;
