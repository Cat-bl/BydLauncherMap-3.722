...
# static fields
.field public static final a:Lf/b/a/j/k0;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lf/b/a/j/k0;

    invoke-direct {v0}, Lf/b/a/j/k0;-><init>()V

    sput-object v0, Lf/b/a/j/k0;->a:Lf/b/a/j/k0;

    const/4 v0, 0x0

    sput-boolean v0, Lf/b/a/j/k0;->c:Z
...
.method public b(Lf/b/a/i/a;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v4}, Lf/b/a/i/a;->a(I)V
    ...
    :cond_5
    iget v1, p1, Lf/b/a/i/a;->l:I

    if-ne v1, v6, :cond_8

    iput v7, p1, Lf/b/a/i/a;->l:I
    ...
    invoke-interface {v0}, Lf/b/a/i/b;->getLocale()Ljava/util/Locale;

    move-result-object p2

    invoke-direct {p1, v1, p2}, Ljava/text/SimpleDateFormat;-><init>(Ljava/lang/String;Ljava/util/Locale;)V

    invoke-interface {v0}, Lf/b/a/i/b;->getTimeZone()Ljava/util/TimeZone;
    ...
    invoke-virtual {p1}, Lf/b/a/i/h;->e()Ljava/lang/ClassLoader;

    move-result-object p1

    invoke-static {v1, p1}, Lf/b/a/l/i;->O(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    :try_start_1
    sget-object p2, Lf/b/a/j/k0;->b:Ljava/lang/reflect/Method;

    if-nez p2, :cond_1b

    sget-boolean p2, Lf/b/a/j/k0;->c:Z

    if-nez p2, :cond_1b

    const-string p2, "java.nio.file.Paths"

    invoke-static {p2}, Lf/b/a/l/i;->N(Ljava/lang/String;)Ljava/lang/Class;
    ...
    sput-object p2, Lf/b/a/j/k0;->b:Ljava/lang/reflect/Method;
    ...
    :catch_3
    sput-boolean v3, Lf/b/a/j/k0;->c:Z
...
.method public c(Lf/b/a/j/d0;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V
    ...
    invoke-virtual {p3, v0}, Lf/b/a/j/x0;->m(Lcom/alibaba/fastjson/serializer/SerializerFeature;)Z
    ...
    invoke-virtual {p3, v3}, Lf/b/a/j/x0;->write(I)V

    sget-object p4, Lf/b/a/a;->DEFAULT_TYPE_KEY:Ljava/lang/String;

    invoke-virtual {p3, p4}, Lf/b/a/j/x0;->u(Ljava/lang/String;)V
    ...
    invoke-virtual {p3, v2, p1, p5}, Lf/b/a/j/x0;->y(CLjava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3, v1}, Lf/b/a/j/x0;->write(I)V
    ...
    invoke-virtual {p3, p5}, Lf/b/a/j/x0;->u(Ljava/lang/String;)V

    invoke-virtual {p1, p4}, Lf/b/a/j/d0;->E(Ljava/lang/Object;)V

    invoke-virtual {p3, v2}, Lf/b/a/j/x0;->write(I)V

    :cond_3
    const-string p1, "port"

    invoke-virtual {p3, p1}, Lf/b/a/j/x0;->u(Ljava/lang/String;)V

    invoke-virtual {p2}, Ljava/net/InetSocketAddress;->getPort()I

    move-result p1

    invoke-virtual {p3, p1}, Lf/b/a/j/x0;->B(I)V
    ...
    :cond_8
    :goto_0
    invoke-virtual {p3, p5}, Lf/b/a/j/x0;->H(Ljava/lang/String;)V

    return-void

    :cond_9
    instance-of p4, p2, Lf/b/a/d;

    if-eqz p4, :cond_a

    check-cast p2, Lf/b/a/d;

    invoke-interface {p2, p3}, Lf/b/a/d;->writeJSONString(Ljava/lang/Appendable;)V
    ...
    invoke-virtual {p0, p1, p3, p2}, Lf/b/a/j/k0;->f(Lf/b/a/j/d0;Lf/b/a/j/x0;Ljava/util/Iterator;)V
...
.method public f(Lf/b/a/j/d0;Lf/b/a/j/x0;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, v0}, Lf/b/a/j/x0;->write(I)V
    ...
    invoke-virtual {p2, v1}, Lf/b/a/j/x0;->write(I)V
    ...
    invoke-virtual {p1, v1}, Lf/b/a/j/d0;->E(Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p1}, Lf/b/a/j/x0;->write(I)V
