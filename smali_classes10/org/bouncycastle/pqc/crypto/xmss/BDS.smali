...
.field private transient wotsPlus:Lo/a/g/b/i/h;


# direct methods
.method private constructor <init>(Lo/a/g/b/i/h;III)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;
...
.method public constructor <init>(Lo/a/g/b/i/t;II)V
    .locals 2

    invoke-virtual {p1}, Lo/a/g/b/i/t;->i()Lo/a/g/b/i/h;

    move-result-object v0

    invoke-virtual {p1}, Lo/a/g/b/i/t;->b()I

    move-result v1

    invoke-virtual {p1}, Lo/a/g/b/i/t;->c()I

    move-result p1

    invoke-direct {p0, v0, v1, p1, p3}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lo/a/g/b/i/h;III)V
...
.method public constructor <init>(Lo/a/g/b/i/t;[B[BLo/a/g/b/i/g;)V
    .locals 4
    ...
    invoke-direct {p0, v0, v1, v2, p1}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lo/a/g/b/i/h;III)V

    invoke-direct {p0, p2, p3, p4}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->initialize([B[BLo/a/g/b/i/g;)V

    return-void
.end method

.method public constructor <init>(Lo/a/g/b/i/t;[B[BLo/a/g/b/i/g;I)V
    .locals 4
    ...
    invoke-direct {p0, p2, p3, p4}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->nextAuthenticationPath([B[BLo/a/g/b/i/g;)V
...
.method public constructor <init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;)V
    ...
    new-instance v0, Lo/a/g/b/i/h;

    iget-object v1, p1, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-virtual {v1}, Lo/a/g/b/i/h;->d()Lo/a/g/b/i/j;

    move-result-object v1

    invoke-direct {v0, v1}, Lo/a/g/b/i/h;-><init>(Lo/a/g/b/i/j;)V

    iput-object v0, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;
...
.method private constructor <init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;ILo/a/a/u;)V
    .locals 3
    ...
    new-instance v1, Lo/a/g/b/i/j;

    invoke-direct {v1, p3}, Lo/a/g/b/i/j;-><init>(Lo/a/a/u;)V
...
.method private constructor <init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;Lo/a/a/u;)V
    .locals 3
    ...
    invoke-direct {v1, p2}, Lo/a/g/b/i/j;-><init>(Lo/a/a/u;)V
...
.method private constructor <init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;[B[BLo/a/g/b/i/g;)V
    .locals 4
...
.method private initialize([B[BLo/a/g/b/i/g;)V
    .locals 10
    ...
    new-instance v0, Lo/a/g/b/i/f$b;

    invoke-direct {v0}, Lo/a/g/b/i/f$b;-><init>()V

    invoke-virtual {p3}, Lo/a/g/b/i/l;->b()I
    ...
    check-cast v0, Lo/a/g/b/i/f$b;

    invoke-virtual {p3}, Lo/a/g/b/i/l;->c()J
    ...
    invoke-virtual {v0}, Lo/a/g/b/i/f$b;->l()Lo/a/g/b/i/l;

    move-result-object v0

    check-cast v0, Lo/a/g/b/i/f;

    new-instance v1, Lo/a/g/b/i/d$b;

    invoke-direct {v1}, Lo/a/g/b/i/d$b;-><init>()V
    ...
    check-cast v1, Lo/a/g/b/i/d$b;

    invoke-virtual {p3}, Lo/a/g/b/i/l;->c()J

    move-result-wide v2

    invoke-virtual {v1, v2, v3}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/d$b;

    invoke-virtual {v1}, Lo/a/g/b/i/d$b;->k()Lo/a/g/b/i/l;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/d;
    ...
    invoke-virtual {v3, v5}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v3, v5, v6}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;

    move-result-object v3

    check-cast v3, Lo/a/g/b/i/g$b;

    invoke-virtual {v3, v2}, Lo/a/g/b/i/g$b;->p(I)Lo/a/g/b/i/g$b;

    move-result-object v3

    invoke-virtual {p3}, Lo/a/g/b/i/g;->e()I

    move-result v5

    invoke-virtual {v3, v5}, Lo/a/g/b/i/g$b;->n(I)Lo/a/g/b/i/g$b;

    move-result-object v3

    invoke-virtual {p3}, Lo/a/g/b/i/g;->f()I

    move-result v5

    invoke-virtual {v3, v5}, Lo/a/g/b/i/g$b;->o(I)Lo/a/g/b/i/g$b;

    move-result-object v3

    invoke-virtual {p3}, Lo/a/g/b/i/l;->a()I

    move-result p3

    invoke-virtual {v3, p3}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;

    move-result-object p3

    check-cast p3, Lo/a/g/b/i/g$b;

    invoke-virtual {p3}, Lo/a/g/b/i/g$b;->l()Lo/a/g/b/i/l;

    move-result-object p3

    check-cast p3, Lo/a/g/b/i/g;

    iget-object v3, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-virtual {v3, p2, p3}, Lo/a/g/b/i/h;->g([BLo/a/g/b/i/g;)[B

    move-result-object v5

    invoke-virtual {v3, v5, p1}, Lo/a/g/b/i/h;->h([B[B)V

    iget-object v3, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-virtual {v3, p3}, Lo/a/g/b/i/h;->e(Lo/a/g/b/i/g;)Lo/a/g/b/i/k;

    move-result-object v3

    new-instance v5, Lo/a/g/b/i/f$b;

    invoke-direct {v5}, Lo/a/g/b/i/f$b;-><init>()V

    invoke-virtual {v0}, Lo/a/g/b/i/l;->b()I

    move-result v6

    invoke-virtual {v5, v6}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;

    move-result-object v5

    check-cast v5, Lo/a/g/b/i/f$b;

    invoke-virtual {v0}, Lo/a/g/b/i/l;->c()J

    move-result-wide v6

    invoke-virtual {v5, v6, v7}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;

    move-result-object v5

    check-cast v5, Lo/a/g/b/i/f$b;

    invoke-virtual {v5, v2}, Lo/a/g/b/i/f$b;->n(I)Lo/a/g/b/i/f$b;

    move-result-object v5

    invoke-virtual {v0}, Lo/a/g/b/i/f;->f()I

    move-result v6

    invoke-virtual {v5, v6}, Lo/a/g/b/i/f$b;->o(I)Lo/a/g/b/i/f$b;

    move-result-object v5

    invoke-virtual {v0}, Lo/a/g/b/i/f;->g()I

    move-result v6

    invoke-virtual {v5, v6}, Lo/a/g/b/i/f$b;->p(I)Lo/a/g/b/i/f$b;

    move-result-object v5

    invoke-virtual {v0}, Lo/a/g/b/i/l;->a()I

    move-result v0

    invoke-virtual {v5, v0}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;
    ...
    iget-object v5, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-static {v5, v3, v0}, Lo/a/g/b/i/r;->a(Lo/a/g/b/i/h;Lo/a/g/b/i/k;Lo/a/g/b/i/f;)Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;

    move-result-object v3

    new-instance v5, Lo/a/g/b/i/d$b;

    invoke-direct {v5}, Lo/a/g/b/i/d$b;-><init>()V

    invoke-virtual {v1}, Lo/a/g/b/i/l;->b()I
    ...
    check-cast v5, Lo/a/g/b/i/d$b;

    invoke-virtual {v1}, Lo/a/g/b/i/l;->c()J
    ...
    invoke-virtual {v5, v2}, Lo/a/g/b/i/d$b;->n(I)Lo/a/g/b/i/d$b;

    move-result-object v5

    invoke-virtual {v1}, Lo/a/g/b/i/l;->a()I

    move-result v1

    invoke-virtual {v5, v1}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v1}, Lo/a/g/b/i/d;->e()I

    move-result v6

    invoke-virtual {v5, v6}, Lo/a/g/b/i/d$b;->m(I)Lo/a/g/b/i/d$b;

    move-result-object v5

    invoke-virtual {v1}, Lo/a/g/b/i/d;->f()I
    ...
    invoke-virtual {v5, v6}, Lo/a/g/b/i/d$b;->n(I)Lo/a/g/b/i/d$b;
    ...
    invoke-static {v5, v6, v3, v1}, Lo/a/g/b/i/r;->b(Lo/a/g/b/i/h;Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;Lo/a/g/b/i/l;)Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;
    ...
    new-instance v3, Lo/a/g/b/i/d$b;

    invoke-direct {v3}, Lo/a/g/b/i/d$b;-><init>()V

    invoke-virtual {v1}, Lo/a/g/b/i/l;->b()I

    move-result v6

    invoke-virtual {v3, v6}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;

    move-result-object v3

    check-cast v3, Lo/a/g/b/i/d$b;

    invoke-virtual {v1}, Lo/a/g/b/i/l;->c()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v3, v6}, Lo/a/g/b/i/d$b;->m(I)Lo/a/g/b/i/d$b;
    ...
    invoke-virtual {v3, v6}, Lo/a/g/b/i/d$b;->n(I)Lo/a/g/b/i/d$b;
    ...
    invoke-virtual {v3, v1}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;
...
.method private nextAuthenticationPath([B[BLo/a/g/b/i/g;)V
    .locals 11
    ...
    invoke-static {v0, v1}, Lo/a/g/b/i/w;->b(II)I
    ...
    :cond_0
    new-instance v1, Lo/a/g/b/i/f$b;

    invoke-direct {v1}, Lo/a/g/b/i/f$b;-><init>()V

    invoke-virtual {p3}, Lo/a/g/b/i/l;->b()I

    move-result v3

    invoke-virtual {v1, v3}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/f$b;

    invoke-virtual {p3}, Lo/a/g/b/i/l;->c()J

    move-result-wide v3

    invoke-virtual {v1, v3, v4}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/f$b;

    invoke-virtual {v1}, Lo/a/g/b/i/f$b;->l()Lo/a/g/b/i/l;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/f;
    ...
    invoke-virtual {v3}, Lo/a/g/b/i/d$b;->k()Lo/a/g/b/i/l;

    move-result-object v3

    check-cast v3, Lo/a/g/b/i/d;
    ...
    invoke-virtual {v0, v3}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v0, v5, v6}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v0, v3}, Lo/a/g/b/i/g$b;->p(I)Lo/a/g/b/i/g$b;
    ...
    invoke-virtual {v0, v3}, Lo/a/g/b/i/g$b;->n(I)Lo/a/g/b/i/g$b;
    ...
    invoke-virtual {v0, v3}, Lo/a/g/b/i/g$b;->o(I)Lo/a/g/b/i/g$b;
    ...
    invoke-virtual {v0, p3}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-virtual {v0, p2, p3}, Lo/a/g/b/i/h;->g([BLo/a/g/b/i/g;)[B

    move-result-object v3

    invoke-virtual {v0, v3, p1}, Lo/a/g/b/i/h;->h([B[B)V

    iget-object v0, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;

    invoke-virtual {v0, p3}, Lo/a/g/b/i/h;->e(Lo/a/g/b/i/g;)Lo/a/g/b/i/k;

    move-result-object v0

    new-instance v3, Lo/a/g/b/i/f$b;

    invoke-direct {v3}, Lo/a/g/b/i/f$b;-><init>()V
    ...
    invoke-virtual {v3, v5}, Lo/a/g/b/i/f$b;->n(I)Lo/a/g/b/i/f$b;

    move-result-object v3

    invoke-virtual {v1}, Lo/a/g/b/i/f;->f()I

    move-result v5

    invoke-virtual {v3, v5}, Lo/a/g/b/i/f$b;->o(I)Lo/a/g/b/i/f$b;

    move-result-object v3

    invoke-virtual {v1}, Lo/a/g/b/i/f;->g()I

    move-result v5

    invoke-virtual {v3, v5}, Lo/a/g/b/i/f$b;->p(I)Lo/a/g/b/i/f$b;
    ...
    invoke-static {v3, v0, v1}, Lo/a/g/b/i/r;->a(Lo/a/g/b/i/h;Lo/a/g/b/i/k;Lo/a/g/b/i/f;)Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;
    ...
    invoke-virtual {v3}, Lo/a/g/b/i/l;->b()I

    move-result v5

    invoke-virtual {v1, v5}, Lo/a/g/b/i/l$a;->g(I)Lo/a/g/b/i/l$a;

    move-result-object v1

    check-cast v1, Lo/a/g/b/i/d$b;

    invoke-virtual {v3}, Lo/a/g/b/i/l;->c()J

    move-result-wide v5

    invoke-virtual {v1, v5, v6}, Lo/a/g/b/i/l$a;->h(J)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v1, v5}, Lo/a/g/b/i/d$b;->m(I)Lo/a/g/b/i/d$b;
    ...
    invoke-virtual {v1, v6}, Lo/a/g/b/i/d$b;->n(I)Lo/a/g/b/i/d$b;

    move-result-object v1

    invoke-virtual {v3}, Lo/a/g/b/i/l;->a()I

    move-result v3

    invoke-virtual {v1, v3}, Lo/a/g/b/i/l$a;->f(I)Lo/a/g/b/i/l$a;
    ...
    invoke-virtual {v3, v6, p1}, Lo/a/g/b/i/h;->h([B[B)V
    ...
    invoke-static {v3, v6, v7, v1}, Lo/a/g/b/i/r;->b(Lo/a/g/b/i/h;Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;Lo/a/g/b/i/l;)Lorg/bouncycastle/pqc/crypto/xmss/XMSSNode;
    ...
    iget-object v7, p0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->wotsPlus:Lo/a/g/b/i/h;
    ...
    invoke-virtual/range {v5 .. v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDSTreeHash;->update(Ljava/util/Stack;Lo/a/g/b/i/h;[B[BLo/a/g/b/i/g;)V
...
.method private validate()V
    ...
    invoke-static {v0, v1, v2}, Lo/a/g/b/i/w;->l(IJ)Z
...
.method public getNextState([B[BLo/a/g/b/i/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    .locals 1

    new-instance v0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;

    invoke-direct {v0, p0, p1, p2, p3}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;[B[BLo/a/g/b/i/g;)V
...
.method public withMaxIndex(ILo/a/a/u;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    .locals 1

    new-instance v0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;

    invoke-direct {v0, p0, p1, p2}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;ILo/a/a/u;)V

    return-object v0
.end method

.method public withWOTSDigest(Lo/a/a/u;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    .locals 1

    new-instance v0, Lorg/bouncycastle/pqc/crypto/xmss/BDS;

    invoke-direct {v0, p0, p1}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lorg/bouncycastle/pqc/crypto/xmss/BDS;Lo/a/a/u;)V
