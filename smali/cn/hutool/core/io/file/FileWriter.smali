...
.method private checkFile()V
    ...
    iget-object v3, p0, Lcn/hutool/core/io/file/FileWrapper;->file:Ljava/io/File;
...
.method public getOutputStream()Ljava/io/BufferedOutputStream;
    ...
    invoke-static {v1}, Le/a/d/m/d;->U(Ljava/io/File;)Ljava/io/File;
...
.method public getWriter(Z)Ljava/io/BufferedWriter;
    ...
    invoke-static {v3}, Le/a/d/m/d;->U(Ljava/io/File;)Ljava/io/File;

    move-result-object v3

    invoke-direct {v2, v3, p1}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V

    iget-object p1, p0, Lcn/hutool/core/io/file/FileWrapper;->charset:Ljava/nio/charset/Charset;
...
.method public write(Ljava/lang/String;Z)Ljava/io/File;
    ...
    iget-object p1, p0, Lcn/hutool/core/io/file/FileWrapper;->file:Ljava/io/File;
...
.method public writeFromStream(Ljava/io/InputStream;Z)Ljava/io/File;
    ...
    invoke-static {p1, v0}, Le/a/d/m/e;->c(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public writeLines(Ljava/lang/Iterable;Lcn/hutool/core/io/file/LineSeparator;Z)Ljava/io/File;
    ...
    invoke-static {v3}, Le/a/d/m/d;->I(Ljava/io/File;)Z
