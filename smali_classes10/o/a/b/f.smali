...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lo/a/b/f;->a:Ljava/security/Permission;
    ...
    sput-object v0, Lo/a/b/f;->b:Ljava/security/Permission;
    ...
    sput-object v0, Lo/a/b/f;->c:Ljava/security/Permission;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lo/a/b/f;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lo/a/b/f;->e:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lo/a/b/f;->f:Ljava/lang/Object;
    ...
    new-instance v5, Lo/a/b/s/l;

    const-string v6, "b869c82b35d70e1b1ff91b28e37a62ecdc34409b"

    invoke-static {v6}, Lo/a/h/k/d;->c(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Lo/a/b/s/l;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lo/a/b/s/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lo/a/b/s/l;)V
    ...
    new-instance v6, Lo/a/b/s/l;

    const-string v7, "77d0f8c4dad15eb8c4f2f8d6726cefd96d5bb399"

    invoke-static {v7}, Lo/a/h/k/d;->c(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Lo/a/b/s/l;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lo/a/b/s/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lo/a/b/s/l;)V

    new-instance v2, Lo/a/b/s/i;
    ...
    new-instance v7, Lo/a/b/s/l;

    const-string v8, "8d5155894229d5e689ee01e6018a237e2cae64cd"

    invoke-static {v8}, Lo/a/h/k/d;->c(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Lo/a/b/s/l;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lo/a/b/s/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lo/a/b/s/l;)V

    new-instance v4, Lo/a/b/s/i;
    ...
    invoke-direct {v3, v8, v9}, Lo/a/b/s/l;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lo/a/b/s/i;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lo/a/b/s/l;)V

    sget-object v3, Lo/a/b/f$a;->c:Lo/a/b/f$a;

    const/4 v5, 0x4

    new-array v6, v5, [Lo/a/b/s/i;
    ...
    invoke-static {v3, v6}, Lo/a/b/f;->d(Lo/a/b/f$a;[Ljava/lang/Object;)V

    sget-object v3, Lo/a/b/f$a;->b:Lo/a/b/f$a;

    new-array v5, v5, [Lo/a/b/s/d;

    invoke-static {v0}, Lo/a/b/f;->f(Lo/a/b/s/i;)Lo/a/b/s/d;

    move-result-object v0

    aput-object v0, v5, v7

    invoke-static {v1}, Lo/a/b/f;->f(Lo/a/b/s/i;)Lo/a/b/s/d;

    move-result-object v0

    aput-object v0, v5, v8

    invoke-static {v2}, Lo/a/b/f;->f(Lo/a/b/s/i;)Lo/a/b/s/d;

    move-result-object v0

    aput-object v0, v5, v9

    invoke-static {v4}, Lo/a/b/f;->f(Lo/a/b/s/i;)Lo/a/b/s/d;

    move-result-object v0

    aput-object v0, v5, v10

    invoke-static {v3, v5}, Lo/a/b/f;->d(Lo/a/b/f$a;[Ljava/lang/Object;)V
...
.method public static b()Ljava/security/SecureRandom;
    ...
    sget-object v0, Lo/a/b/f;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lo/a/b/f;->g:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Lo/a/b/f;->g:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Lo/a/b/f;->g:Ljava/security/SecureRandom;
...
.method public static varargs d(Lo/a/b/f$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lo/a/b/f$a;->b(Lo/a/b/f$a;)Ljava/lang/Class;
    ...
    invoke-static {p0, p1}, Lo/a/b/f;->e(Lo/a/b/f$a;[Ljava/lang/Object;)V

    sget-object v0, Lo/a/b/f;->e:Ljava/util/Map;

    invoke-static {p0}, Lo/a/b/f$a;->a(Lo/a/b/f$a;)Ljava/lang/String;
...
.method public static e(Lo/a/b/f$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Lo/a/b/f;->d:Ljava/lang/ThreadLocal;
...
.method public static f(Lo/a/b/s/i;)Lo/a/b/s/d;
    .locals 9

    invoke-virtual {p0}, Lo/a/b/s/i;->b()Ljava/math/BigInteger;
    ...
    invoke-static {v0}, Lo/a/b/f;->a(I)I

    move-result v5

    new-instance v0, Lo/a/b/s/d;

    invoke-virtual {p0}, Lo/a/b/s/i;->b()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p0}, Lo/a/b/s/i;->a()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lo/a/b/s/i;->c()Ljava/math/BigInteger;

    move-result-object v4

    new-instance v8, Lo/a/b/s/g;

    invoke-virtual {p0}, Lo/a/b/s/i;->d()Lo/a/b/s/l;

    move-result-object v1

    invoke-virtual {v1}, Lo/a/b/s/l;->b()[B
    ...
    invoke-virtual {p0}, Lo/a/b/s/l;->a()I

    move-result p0

    invoke-direct {v8, v1, p0}, Lo/a/b/s/g;-><init>([BI)V
    ...
    invoke-direct/range {v1 .. v8}, Lo/a/b/s/d;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lo/a/b/s/g;)V
